globalThis.__flowordProduction = {
  ...
  ,cancel: (request) => ({ protocol: 'floword-production', protocolVersion: 1, ok: true, requestId: request.requestId, jobId: request.jobId, stepId: request.stepId, attemptId: request.attemptId, leaseId: request.leaseId, profileId: request.profileId })
};
