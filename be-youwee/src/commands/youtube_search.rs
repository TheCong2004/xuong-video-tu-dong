...
#[tauri::command]
pub async fn search_youtube_videos(query: String, limit: Option<u32>, filters: Option<YoutubeSearchFilters>, continuation: Option<String>) -> Result<YoutubeSearchResponse, String> {
