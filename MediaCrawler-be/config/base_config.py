...
XHS_INTERNATIONAL = os.getenv("MEDIACRAWLER_XHS_INTERNATIONAL", "false").strip().lower() in {"1", "true", "yes", "on"}

KEYWORDS = "编程副业,编程兼职"  # Keyword search configuration, separated by English commas
LOGIN_TYPE = "qrcode"  # qrcode or phone or cookie
# Floword account lifecycle action. Empty means normal crawling; `login` and
# `verify` stop before crawling after using the platform's real client `pong()`.
SESSION_ACTION = ""
COOKIES = ""
CRAWLER_TYPE = (
