...
export default function DegradationBadge() {
  ...
  return (
    <Link
      ...
      className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-amber-500/10 text-amber-500 hover:bg-amber-500/20 transition-colors border border-white/10"
