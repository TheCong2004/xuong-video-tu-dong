...
export const SIDE_NAV: SideNavItem[] = [
  ...
  { id: "local-draft", label: "Bản nháp nội bộ", icon: faHardDrive },
  { id: "auto-render", label: "Xuất video", icon: faRobot },
  ...
  { id: "stickers", label: "Nhãn dán", icon: faFaceSmile },
  ...
  { id: "media", label: "Tệp / Mặt nạ", icon: faPhotoFilm },
  { id: "keyframe", label: "Khung khóa", icon: faDiamond },
