    ...
    <div className="flex min-h-0 min-w-0 flex-1 flex-col">
      <div className="flex items-center justify-between gap-2 px-4 pt-4 pb-2">
        ...
        <button
          type="button"
          onClick={onImport}
          className="flex items-center gap-1.5 rounded-lg border border-white/10 bg-[#252830] px-3 py-1.5 text-[12px] font-medium text-white/70 hover:bg-[#2a2d35] hover:text-white"
        >
      ...
      <div className="min-h-[120px] flex-1 overflow-y-auto border-t border-white/10">
        {filtered.length === 0 ? (
