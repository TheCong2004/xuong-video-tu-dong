    ...
    <footer className="h-24 flex-shrink-0 glass-panel border-t border-cyber-border-subtle">
      <div className="h-full px-6 flex items-center justify-center gap-6">
        ...
        <div className="w-14 h-14 rounded-lg overflow-hidden border-2 border-cyber-neon-cyan/60 flex-shrink-0 shadow-glow-cyan-sm">
          <img
            src="/mediacrawler/logos/my_logo.png"
            alt="Tác giả Relakkes"
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            title="GitHub"
          >
            <img src="/mediacrawler/logos/github.png" alt="GitHub" className="w-6 h-6 object-contain" />
          </a>
          <a
            ...
            title="Bilibili"
          >
            <img src="/mediacrawler/logos/bilibili_logo.png" alt="Bilibili" className="w-6 h-6 object-contain" />
          </a>
          <a
            ...
            title="Xiaohongshu"
          >
            <img src="/mediacrawler/logos/xiaohongshu_logo.png" alt="Xiaohongshu" className="w-6 h-6 object-contain" />
          </a>
          <a
            ...
            title="Douyin"
          >
            <img src="/mediacrawler/logos/douyin.png" alt="Douyin" className="w-6 h-6 object-contain" />
          </a>
        </div>
      </div>
    </footer>
