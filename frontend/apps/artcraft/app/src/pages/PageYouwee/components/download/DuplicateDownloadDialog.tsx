      ...
      <DialogContent className="max-h-[86vh] max-w-3xl gap-0 overflow-hidden border-white/10 bg-card/95 p-0 shadow-2xl backdrop-blur-xl">
        ...
        <div className="max-h-[50vh] overflow-y-auto px-4 py-4 sm:px-5">
          <div className="space-y-2">
            {previewItems.map((item) => {
              ...
              return (
                <div
                  ...
                  className="group rounded-md border border-border/60 bg-background/45 p-3 transition-colors hover:border-border/90 hover:bg-background/60"
                >
            ...
            {remainingCount > 0 && (
              <div className="rounded-md border border-dashed border-border/70 bg-background/30 px-3 py-2 text-center text-xs text-muted-foreground">
