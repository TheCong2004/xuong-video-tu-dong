          ...
          <div className="max-h-[80vh] space-y-4 overflow-y-auto pr-1">
            ...
            <div className="space-y-4 rounded-md border border-border/60 bg-muted/20 p-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3 rounded-md border border-border/60 bg-background/80 px-3 py-3">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-border/60 bg-muted/50 text-muted-foreground">
        ...
        <DialogContent className="sm:max-w-[560px]">
          ...
          <div className="space-y-3">
            ...
            {controller.attachWorkspacePath && (
              <div className="break-all rounded-lg border border-border/60 bg-card p-3 text-xs text-muted-foreground">
                {controller.attachWorkspacePath}
              </div>
            )}
          </div>
      ...
      <Dialog open={controller.runtimeGuideOpen} onOpenChange={controller.setRuntimeGuideOpen}>
        <DialogContent className="sm:max-w-[640px]">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-md bg-card p-3 text-[11px] text-muted-foreground">
            ...
            <div className="grid gap-3 lg:grid-cols-2">
              {(['javascript', 'python'] as const).map((language) => {
                ...
                return (
                  <div key={language} className="rounded-md border border-border/60 p-3">
                    <div className="space-y-1">
