  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="grid gap-2 lg:grid-cols-[1fr_auto]">
        ...
        <div className="inline-flex h-9 w-full items-center overflow-x-auto rounded-md border border-border bg-muted/40 p-0.5 lg:w-auto">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <Select value={sort} onValueChange={(value) => setSort(value as HistorySort)}>
            <SelectTrigger
              className={cn(
                'h-8 w-auto min-w-[98px] max-w-[130px] rounded-md px-2.5 gap-1.5',
                'bg-card border-border text-xs text-muted-foreground hover:text-foreground',
                '[&>span]:truncate',
              )}
            >
          ...
          <button
            ...
            className={cn(
              'flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium',
              'border border-destructive/30 hover:bg-destructive/10 transition-colors',
