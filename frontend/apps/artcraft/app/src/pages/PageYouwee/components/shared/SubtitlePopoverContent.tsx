...
export function SubtitlePopoverContent<TMode extends string, TFormat extends string>({
  ...
  return (
    <>
      <div
        className={cn(
          'flex border-b border-border bg-panel px-4 py-3',
            ...
            <div className="grid grid-cols-3 gap-1.5">
              {mode.options.map((option) => (
                <button
                  ...
                  className={cn(
                    'h-8 rounded-md px-2 text-xs font-medium transition-colors duration-150',
                ...
                {languageCodes.map((code) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        'flex h-7 items-center gap-1 rounded-md border px-2 text-[11px] font-medium transition-colors duration-150',
                        isSelected
