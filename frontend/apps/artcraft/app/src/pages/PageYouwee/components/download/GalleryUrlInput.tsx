        ...
        {!isExpanded ? (
          <div className="relative flex items-center gap-2">
            ...
            <button
              ...
              className="h-11 rounded-md px-4 text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 flex items-center gap-2 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {isAdding ? (
