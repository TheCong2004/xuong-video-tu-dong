            ...
            <div className="p-3 space-y-2.5 border-b flex-shrink-0">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <Popover>
                  ...
                  <PopoverContent
                    className="w-80 p-0 overflow-hidden border-border shadow-md"
                    align="end"
                    sideOffset={8}
                  >
                    <div className="px-4 py-3 border-b bg-panel">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-3 rounded-lg bg-background border border-border overflow-x-auto">
                      <code className="text-xs text-muted-foreground break-all whitespace-pre-wrap font-mono block">
