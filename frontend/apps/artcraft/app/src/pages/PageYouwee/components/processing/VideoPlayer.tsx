...
export const VideoPlayer = memo(function VideoPlayer({
  ...
  return (
    <section
      className={cn(
        'relative rounded-md overflow-hidden w-full',
        'bg-black',
    ...
    >
      {isLoadingVideo || isGeneratingPreview ? (
        ...
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div className="absolute inset-x-0 top-0 p-3 pb-8 bg-black/70">
            <div className="flex items-center gap-2">
              {videoPath && (
          ...
          <div className="absolute inset-x-0 bottom-0 p-3 pt-8 bg-black/70">
