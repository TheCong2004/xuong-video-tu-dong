              ...
              <SettingsCard className={cn('space-y-0', tone.cardClassName)}>
                ...
                <CollapsibleContent>
                  <div className="relative z-10 space-y-4 pt-4">
                    <div className={cn('rounded-md border border-dashed p-4', tone.panelClassName)}>
                    ...
                    {workflowPlugins.length === 0 ? (
                      <div
                        className={cn(
                          'rounded-md border border-dashed px-4 py-6 text-center',
                          tone.emptyClassName,
                        )}
                      >
                      ...
                      <div className="space-y-3">
                        {workflowPlugins.map(({ step, plugin }, index) => {
                          ...
                          return (
                            <div
                              key={`${trigger}-${plugin.manifest.id}`}
                              className={cn('rounded-md border p-4', tone.stepClassName)}
                            >
