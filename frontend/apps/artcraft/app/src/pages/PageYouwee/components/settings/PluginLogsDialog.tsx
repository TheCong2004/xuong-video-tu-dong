        ...
        <ScrollArea className="flex-1">
          <div className="space-y-3 px-6 py-5">
            ...
            {loading && logs.length === 0 ? (
              <div className="rounded-md border border-border/60 bg-panel px-4 py-6 text-sm text-muted-foreground">
                {t('download.pluginLogsLoading')}
              </div>
            ) : logs.length === 0 ? (
              <div className="rounded-md border border-dashed border-border/70 bg-panel px-4 py-8 text-center">
