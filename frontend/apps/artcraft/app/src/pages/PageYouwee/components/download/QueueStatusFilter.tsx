        ...
        {FILTERS.map((filter) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={cn(
                  'inline-flex h-[18px] min-w-[18px] items-center justify-center rounded-md px-1 tabular-nums text-[10px] font-bold leading-none transition-all duration-200',
                  active
  ...
  return (
    <div className="flex h-full min-h-[240px] flex-col items-center justify-center px-4 py-12 text-center">
      ...
      <button
        type="button"
        onClick={onShowAll}
        className="mt-3 inline-flex h-8 items-center rounded-md bg-primary/10 px-4 text-xs font-semibold text-primary transition-colors hover:bg-primary/15 hover:text-primary"
      >
        {actionLabel}
      </button>
    </div>
