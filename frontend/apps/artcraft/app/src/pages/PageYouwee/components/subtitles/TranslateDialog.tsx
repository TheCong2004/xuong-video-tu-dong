...
export function TranslateDialog({ open, onClose }: TranslateDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50  ">
      <div className="bg-card rounded-md shadow-none border border-border w-[440px] overflow-hidden">
        {/* Header */}
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={targetLang} onValueChange={setTargetLang}>
              <SelectTrigger
                id="translate-target"
                className="h-10 rounded-lg border-border bg-background/80 shadow-none focus:ring-2 focus:ring-primary/30"
              >
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center justify-between rounded-lg border border-border px-3 py-2 bg-background/70">
            <div>
