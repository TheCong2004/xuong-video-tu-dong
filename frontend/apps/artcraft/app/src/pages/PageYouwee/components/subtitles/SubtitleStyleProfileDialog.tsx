...
export function SubtitleStyleProfileDialog({ open, onClose }: SubtitleStyleProfileDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50  ">
      <div className="bg-card rounded-md shadow-none border border-border w-[760px] max-w-[92vw] overflow-hidden">
          ...
          <div className="rounded-md border border-border bg-muted/20 p-3.5 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 items-end">
              <div className="space-y-1">
                ...
                >
                  <SelectTrigger className="h-9 rounded-lg border border-border bg-background px-2.5 text-sm outline-none focus:ring-2 focus:ring-primary/25">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full h-9 rounded-lg border border-border bg-background px-2.5 text-sm outline-none focus:ring-2 focus:ring-primary/25"
                />
              </div>
              <div className="space-y-1">
                <label
            ...
            <div className="flex justify-end">
              <button
                ...
                className="px-3.5 py-2 text-sm rounded-lg border border-border hover:bg-accent transition-colors"
              >
