...
export function SplitMergeDialog({ open, onClose }: SplitMergeDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50  ">
      <div className="bg-card rounded-md shadow-none border border-border w-[560px] overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            <button
              ...
              className="h-10 inline-flex items-center justify-center gap-2 rounded-lg border border-dashed border-border text-sm font-medium hover:bg-accent transition-colors"
            >
              <Scissors className="w-4 h-4" />
              {t('splitMerge.smartSplitActive')}
            </button>

            <div className="rounded-lg border border-border p-3 space-y-2 bg-background/70">
              ...
              <button
                ...
                className="h-9 px-3 rounded-md text-sm border border-dashed border-border hover:bg-accent transition-colors"
              >
