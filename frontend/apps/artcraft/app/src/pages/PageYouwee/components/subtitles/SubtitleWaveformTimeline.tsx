  ...
  return (
    <div className="border-b border-border/50 bg-background/40">
      ...
      <div ref={wrapperRef} className="px-3 pb-3">
        <div
          ref={scrollRef}
          className="relative overflow-x-auto rounded-md border border-border bg-muted/10"
        >
          {isDecoding && (
            <div className="absolute inset-0 z-20 bg-background/70   flex items-center justify-center gap-2 text-xs text-muted-foreground">
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : isSelected
                          ...
                          : 'bg-primary/10 border-primary/25 hover:bg-primary/18',
