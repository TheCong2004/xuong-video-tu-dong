...
export function TimingDialog({ open, onClose }: TimingDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50  ">
      <div className="bg-card rounded-md shadow-none border border-border w-[460px] overflow-hidden">
        {/* Header */}
              ...
              <div className="rounded-lg border border-border bg-background/70 p-3 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={cn(
                      'h-8 px-3 rounded-md text-xs font-medium border border-dashed border-border',
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    max={0.95}
                    step={0.01}
                    className="w-full h-9 px-3 rounded-md text-sm bg-background border border-border outline-none"
                  />
                </div>
              ...
              <div className="rounded-lg border border-border bg-background/70 p-3 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={cn(
                      'h-8 px-3 rounded-md text-xs font-medium border border-dashed border-border inline-flex items-center gap-1.5',
                      'hover:bg-accent transition-colors',
                    )}
                  >
