...
export function AISection({ highlightId }: AISectionProps) {
  ...
  const providers: {
    ...
    },
    {
      ...
      type: 'custom',
      logo: (
        <div className="w-10 h-10 rounded-md bg-slate-500/10 flex items-center justify-center flex-shrink-0">
          <svg
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <SettingsCard className="relative overflow-hidden">
          ...
          <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex shrink-0 items-center gap-2 rounded-md bg-background px-3 py-2">
      ...
      {ai.config.enabled ? (
              ...
              {providers.map((prov) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'relative flex items-center gap-3 text-left p-3.5 rounded-md transition-all duration-200 group w-full',
          ...
          <SettingsCard className="p-5 space-y-4">
            ...
            {ai.config.provider !== 'ollama' && ai.config.provider !== 'lmstudio' && (
              <div
                id="ai-api-key"
                className={cn(
                  'space-y-3 p-3 rounded-md bg-muted/20 transition-all duration-300',
              ...
              >
                ...
                <div className="flex flex-col items-stretch gap-2.5 sm:flex-row sm:items-center">
                  ...
                  <Button
                    ...
                    className="w-full sm:w-auto h-10 bg-primary hover:bg-primary/90 text-primary-foreground px-5  shadow-primary/10 active:scale-95 transition-transform"
                  >
                    {ai.isTesting ? (
            ...
            {ai.config.provider === 'ollama' && (
              <div className="space-y-3 p-3 rounded-md bg-muted/20">
            ...
            {ai.config.provider === 'proxy' && (
              <div className="space-y-4 p-3 rounded-md bg-muted/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-1.5 p-1 bg-muted/50 border border-border/50 rounded-lg">
                    {[
                    ...
                    {(ai.config.transcript_languages || DEFAULT_TRANSCRIPT_LANGUAGES).map(
                      (code, index) => {
                        ...
                        return (
                          <div
                            key={code}
                            className="flex items-center gap-2.5 p-2 rounded-lg bg-card border border-border/40 hover:bg-muted/50 transition-colors group"
                          >
          ...
          >
            ...
            {ai.config.whisper_enabled && (
              <div className="space-y-4 pl-4 border-l-2 border-primary/20 pt-1 animate-in slide-in-from-left-3 duration-300">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-muted/20 p-2 rounded-md border border-border/50">
                ...
                {ai.config.whisper_endpoint_url !== undefined ? (
                  ...
                  <div className="space-y-3 bg-muted/20 p-3 rounded-lg">
                    ...
                    <div className="flex items-start gap-1.5 rounded-md bg-panel px-2 py-1.5 text-[10px] leading-normal text-muted-foreground">
        ...
        <div className="flex flex-col items-center justify-center p-8 text-center bg-muted/20 border border-dashed border-border/80 rounded-md space-y-4 max-w-2xl mx-auto py-12 relative overflow-hidden transition-all duration-300">
          <div className="absolute top-0 left-0 w-24 h-24 bg-primary/5 rounded-full blur-2xl" />

          <div className="w-16 h-16 rounded-full border border-border bg-panel flex items-center justify-center border border-primary/20  shadow-primary/5">
          ...
          <Button
            ...
            className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium px-6 py-5 rounded-md active:scale-95 transition-all flex items-center gap-2"
          >
