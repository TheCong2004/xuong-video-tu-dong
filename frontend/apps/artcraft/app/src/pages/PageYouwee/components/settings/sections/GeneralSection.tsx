...
/** Solid North swatches from theme primary (dark) values */
    ...
    <div className="space-y-6">
      ...
      >
        <SettingsCard>
          ...
          >
            <div className="flex w-full flex-wrap items-center gap-0.5 rounded-md border border-border bg-panel p-0.5 sm:w-auto">
              <button
                type="button"
          ...
          <div
            id="theme"
            className={cn(
              'py-2.5 rounded-md px-2 -mx-2 transition-[background-color,box-shadow] duration-150',
              highlightId === 'theme' && 'bg-primary/5 ring-1 ring-primary/30',
            )}
          >
            <p className="text-sm font-medium mb-2.5">{t('general.colorTheme')}</p>
            <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-2 xl:grid-cols-3">
              {themes.map((themeItem) => (
                <button
                  ...
                  className={cn(
                    'group flex items-center gap-3 p-2.5 rounded-md transition-colors duration-150',
                    'border',
