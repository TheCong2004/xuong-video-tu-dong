...
export function FindReplacePanel({ open, onClose }: FindReplacePanelProps) {
  ...
  return (
    <div className="rounded-md border border-border bg-panel px-3 py-2.5 flex-shrink-0">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs font-medium rounded-md border border-border hover:bg-accent disabled:opacity-40 transition-colors"
            >
            ...
            <button
              ...
              disabled={matches.length === 0}
              className="px-3 py-1.5 text-xs font-medium rounded-md border border-dashed border-border hover:bg-accent disabled:opacity-40 transition-colors"
            >
