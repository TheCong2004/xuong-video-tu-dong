...
export function VideoTimeline({
  ...
  return (
    <div
      ref={trackRef}
      className={cn(
        'relative h-11 cursor-pointer select-none rounded-md border border-border bg-panel group',
        className,
      )}
    ...
    >
      ...
      {/* Hover effect */}
      <div className="absolute inset-0 rounded-md opacity-0 group-hover:opacity-100 transition-opacity bg-white/5" />
    </div>
  );
}
