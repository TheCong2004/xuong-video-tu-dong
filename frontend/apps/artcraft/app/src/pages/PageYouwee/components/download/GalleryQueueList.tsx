        ...
        <div className="flex flex-wrap justify-center gap-2 mb-4 max-w-[380px]">
          {POPULAR_SITES.map((site) => (
            <span
              key={site.name}
              className={cn(
                'inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-muted/50 text-[11px]',
                site.color,
              )}
            >
              <span>{site.name}</span>
          ...
          <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-muted/50 text-[11px] text-muted-foreground">
