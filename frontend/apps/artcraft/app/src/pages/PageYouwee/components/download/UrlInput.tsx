  ...
  return (
    <section
      className={cn(
        ...
        isDragOver && 'ring-2 ring-primary ring-offset-2 ring-offset-background rounded-md',
      )}
    ...
    >
      ...
      <div className="relative">
        {!isExpanded ? (
          ...
          <div className="relative flex items-center gap-2">
            ...
            <button
              type="button"
              className="h-11 px-4 rounded-md font-medium text-sm bg-primary text-primary-foreground hover:bg-primary/90 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              onClick={handleAdd}
      ...
      <div className="flex items-center gap-2 flex-wrap">
        {isExpanded && (
          <button
            type="button"
            className="h-9 px-4 rounded-md font-medium text-sm bg-primary text-primary-foreground hover:bg-primary/90 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            onClick={handleAdd}
            disabled={disabled || !value.trim() || isAdding || isExpandingPlaylist}
      ...
      <Dialog open={showGuideDialog} onOpenChange={setShowGuideDialog}>
        <DialogContent className="sm:max-w-[560px]">
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg bg-amber-500/10 border border-white/10 px-3 py-2.5">
      ...
      {/* Drag Drop Hint */}
      {isDragOver && (
        <div className="absolute inset-0 bg-primary/10 backdrop-blur-sm rounded-md flex items-center justify-center z-10">
