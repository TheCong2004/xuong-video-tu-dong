      ...
      <div className="flex-shrink-0 space-y-2.5 border-b border-border bg-panel/40 px-4 py-3 sm:px-5">
        ...
        <div className="relative">
          <Textarea
            ...
            className="min-h-[92px] resize-none bg-background border-border font-mono text-sm"
          />
          {inputCount > 0 && (
        ...
        <div className="flex flex-wrap items-center gap-2 rounded-md border border-border bg-panel p-3">
          ...
          <div className="inline-flex items-center rounded-md bg-background p-0.5">
            <button
              type="button"
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden px-4 pt-3 sm:px-5">
        {rows.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center text-center py-12">
            ...
            {isExtracting ? (
              <div className="mt-1 w-full max-w-sm rounded-md border border-border bg-panel p-3 text-left ">
                ...
                <div className="mt-3 space-y-2">
                  {[0, 1, 2].map((index) => (
                    <div key={index} className="flex items-center gap-2">
                      ...
                      <span
                        className={cn(
                          'h-2 rounded-full bg-muted animate-pulse',
                          index === 0 && 'w-11/12',
                          index === 1 && 'w-8/12',
                          index === 2 && 'w-10/12',
                        )}
          ...
          <div className="grid min-h-0 flex-1 grid-rows-[auto_minmax(0,1fr)]">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-9 w-48 pl-8 bg-background"
                  />
                </div>
            ...
            <div className="min-h-0 overflow-auto overscroll-contain rounded-md border border-border bg-card">
