...
export function ChannelDetailView({ channel, onBack }: ChannelDetailViewProps) {
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <Input
                  ...
                  className="w-16 h-9 text-sm border-border"
                />
              </div>
            </div>
                ...
                {!settingsIsAudioMode && (
                  <div className="flex items-center gap-1.5">
                    ...
                    <select
                      ...
                      className="h-8 px-2 rounded-md text-xs bg-background border border-border/50"
                    >
            ...
            <div className="flex items-center justify-end gap-2 pt-1">
              ...
              <button
                ...
                className={cn(
                  ...
                  'inline-flex items-center gap-1.5 bg-primary text-primary-foreground hover:bg-primary/90',
      ...
      <div className="flex-shrink-0 border-b border-border bg-panel/40 px-4 py-2.5 sm:px-5">
        <ChannelSettingsBar
          quality={quality}
          format={format}
      ...
      {browseVideos.length > 0 && (
        <div className="flex flex-shrink-0 items-center justify-between border-b border-border px-4 py-1.5 sm:px-5">
            ...
            <div className="flex items-center gap-2">
              {!isDownloading ? (
                <button
                  type="button"
                  className={cn(
                    'inline-flex h-9 flex-1 items-center justify-center gap-2 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground hover:bg-primary/90',
                ...
                >
                  ...
                  {pendingCount > 0 && (
                    <span className="ml-1 rounded-sm bg-primary-foreground/15 px-1.5 py-0.5 text-xs">
                      {pendingCount}
                    </span>
                  )}
                </button>
