...
// Immutable update helpers for the SceneTracks tree. The timeline state
// is treated as a value — every mutation returns a fresh SceneTracks
// with structural sharing for the unchanged branches.
