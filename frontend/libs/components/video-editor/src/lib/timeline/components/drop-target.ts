import type { TimelineTrack, TimelineElement } from "../types";
import type { ComputeDropTargetParams, DropTarget } from "../types";
import { resolveTrackPlacement } from "../placement";
