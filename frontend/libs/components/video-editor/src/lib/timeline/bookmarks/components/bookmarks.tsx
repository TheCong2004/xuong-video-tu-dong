...
import { DEFAULT_TIMELINE_BOOKMARK_COLOR } from "../../components/theme";
import { TIMELINE_BOOKMARK_ROW_HEIGHT_PX } from "../../components/layout";
...
import { timelineTimeToPixels, timelineTimeToSnappedPixels } from "../../pixel-utils";
import {
  type MediaTime,
