...
// Lightweight type predicates and File → MediaType inference. The
// upload flow uses getMediaTypeFromFile to dispatch import logic per
// kind; mediaSupportsAudio gates UI affordances like volume sliders.
