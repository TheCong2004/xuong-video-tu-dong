...
// Thin wrappers over resolveAnimationPathValueAtTime that constrain the
// propertyPath to the right type-family (numeric vs color), so callers
// don't have to cast their fallback values at the boundary.
