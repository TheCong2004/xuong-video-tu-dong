...
import { getMaskDefinition } from "./index";
import { appendPointToFreeformPathMask } from "./freeform/definition";
import {
...
import type { Mask, MaskHandleId, MaskInteractionResult } from "./types";
