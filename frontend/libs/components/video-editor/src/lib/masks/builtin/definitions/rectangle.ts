...
// Rectangle mask — four corners, rotated as a unit. No overlay path
// (the bounding-box rect IS the shape), so buildBoxMaskInteraction
// doesn't pass a buildOverlayPath.
