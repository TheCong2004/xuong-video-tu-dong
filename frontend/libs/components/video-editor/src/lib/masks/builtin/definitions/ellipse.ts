...
// Ellipse mask. The bounding box overlay is rectangular (matches
// box-like behaviour) and a separate shape-outline overlay draws the
// elliptical curve so users see both the gesture target and the
// resulting shape.
