...
import { STICKER_INTRINSIC_SIZE_FALLBACK } from "./intrinsic-size";
...
export { STICKER_INTRINSIC_SIZE_FALLBACK } from "./intrinsic-size";
export { stickersRegistry, StickersRegistry } from "./registry";
