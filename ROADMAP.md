...
- Build the best "tangible" computing surfaces where you can mold scenes and videos like 
  clay and direct them with precision and clarity.

- Add every model and provider into ArtCraft so you can build your own crafting IDE. 
...
- Build an *Open* OpenAI / Google / Anthropic. Open models, open platforms, open hardware.
