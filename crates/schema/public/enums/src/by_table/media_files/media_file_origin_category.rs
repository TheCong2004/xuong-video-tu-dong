...
pub enum MediaFileOriginCategory {
  ...
  /// Third-party inference output (e.g. FAL, Replicate).
  /// The file was generated by a third-party AI service and uploaded by the client.
  #[serde(rename = "inference3rd")]
  ThirdPartyInference,
...
impl MediaFileOriginCategory {
  pub fn to_str(&self) -> &'static str {
    match self {
      ...
      Self::ThirdPartyInference => "inference3rd",
  ...
  pub fn from_str(value: &str) -> Result<Self, String> {
    match value {
      ...
      "inference3rd" => Ok(Self::ThirdPartyInference),
...
mod tests {
  ...
  mod explicit_checks {
    ...
    fn test_serialization() {
      ...
      assert_serialization(MediaFileOriginCategory::ThirdPartyInference, "inference3rd");
    ...
    fn test_to_str() {
      ...
      assert_eq!(MediaFileOriginCategory::ThirdPartyInference.to_str(), "inference3rd");
    ...
    fn test_from_str() {
      ...
      assert_eq!(MediaFileOriginCategory::from_str("inference3rd").unwrap(), MediaFileOriginCategory::ThirdPartyInference);
    ...
    fn all_variants() {
      ...
      assert_eq!(variants.pop_first(), Some(MediaFileOriginCategory::ThirdPartyInference));
