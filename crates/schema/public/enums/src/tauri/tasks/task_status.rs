...
impl TaskStatus {
  ...
  pub fn all_variants() -> BTreeSet<Self> {
    ...
    BTreeSet::from([Self::Pending, Self::Started, Self::WaitingInput, Self::CompleteSuccess, Self::CompleteFailure, Self::AttemptFailed, Self::Dead, Self::CancelledByUser, Self::CancelledByProvider, Self::CancelledByUs])
  }
}
...
mod tests {
  ...
  mod explicit_checks {
    ...
    fn test_serialization() {
      ...
      assert_serialization(TaskStatus::WaitingInput, "waiting_input");
    ...
    fn to_str() {
      ...
      assert_eq!(TaskStatus::WaitingInput.to_str(), "waiting_input");
    ...
    fn from_str() {
      ...
      assert_eq!(TaskStatus::from_str("waiting_input").unwrap(), TaskStatus::WaitingInput);
    ...
    fn all_variants() {
      ...
      assert_eq!(variants.pop_first(), Some(TaskStatus::WaitingInput));
