...
pub async fn get_weight_for_legacy_tts_info(weight_token: &ModelWeightToken, can_see_deleted: bool, mysql_pool: &MySqlPool) -> AnyhowResult<Option<ModelWeightForLegacyTtsInfo>> {
  let mut connection = mysql_pool.acquire().await?;
  get_weight_for_legacy_tts_info_with_connection(weight_token, can_see_deleted, &mut connection).await
}

pub async fn get_weight_for_legacy_tts_info_with_connection(weight_token: &ModelWeightToken, can_see_deleted: bool, mysql_connection: &mut PoolConnection<MySql>) -> AnyhowResult<Option<ModelWeightForLegacyTtsInfo>> {
