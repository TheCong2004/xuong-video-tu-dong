...
pub async fn list_weights_by_creator_username(args: ListWeightsForUserArgs<'_>) -> AnyhowResult<WeightsForUserListPage> {
  ...
  let mut count_query_builder = query_builder(args.creator_username, false, 0, 0, args.sort_ascending, count_fields.as_str(), args.view_as, args.maybe_scoped_weight_type, args.maybe_scoped_weight_category);
  ...
  let mut query = query_builder(args.creator_username, true, args.page_index, args.page_size, args.sort_ascending, result_fields.as_str(), args.view_as, args.maybe_scoped_weight_type, args.maybe_scoped_weight_category);
  ...
  Ok(WeightsForUserListPage { records: weights_records, sort_ascending: args.sort_ascending, current_page: args.page_index, total_page_count: number_of_pages })
}
...
fn query_builder<'a>(username: &'a str, enforce_limits: bool, page_index: usize, page_size: usize, sort_ascending: bool, select_fields: &'a str, view_as: ViewAs, maybe_scoped_weight_type: Option<WeightsType>, maybe_scoped_weight_category: Option<WeightsCategory>) -> QueryBuilder<'a, MySql> {
