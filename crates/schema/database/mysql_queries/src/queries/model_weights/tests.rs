...
mod tests {
  ...
  use crate::queries::model_weights::delete_weights::{delete_weights_as_mod, delete_weights_as_user, undelete_weights_as_mod, undelete_weights_as_user};
  ...
  async fn setup() -> sqlx::Pool<sqlx::MySql> {
    ...
    let pool = MySqlPoolOptions::new().max_connections(3).connect(&db_connection_string).await.unwrap();
  ...
  async fn list_all_weights_by_user() -> AnyhowResult<()> {
    ...
    let weights_by_username = list_weights_by_creator_username(ListWeightsForUserArgs { creator_username: &creator_username, page_size: 0, page_index: 0, sort_ascending: false, view_as, maybe_scoped_weight_type: None, maybe_scoped_weight_category: None, mysql_pool: &pool }).await?;
  ...
  async fn seed_weights_with_category_and_type(weights_type: WeightsType, weights_category: WeightsCategory, number_of_items: u32, creator_username: &str) -> AnyhowResult<()> {
    let pool = setup().await;
    let creator_token = get_user_token_by_username(&creator_username, &pool).await?.unwrap_or_else(|| panic!("Could not find user with username {}", creator_username));
  ...
  async fn list_weights_query_build_test_paging() -> AnyhowResult<()> {
    ...
    let qb = ListWeightsQueryBuilder::new().offset(Some(0)).weights_type(Some(WeightsType::LoRA)).weights_category(Some(WeightsCategory::ImageGeneration)).limit(10).scope_creator_username(Some("hanashi")).include_user_deleted_results(false);
    ...
    let qb = ListWeightsQueryBuilder::new().weights_type(Some(WeightsType::LoRA)).weights_category(Some(WeightsCategory::ImageGeneration)).scope_creator_username(Some("hanashi")).include_user_deleted_results(false).offset(Some(10)).limit(10);
  ...
  async fn list_weights_query_build_test_asc_desc_cursor_reverse() -> AnyhowResult<()> {
    ...
    let qb = ListWeightsQueryBuilder::new().offset(Some(0)).weights_type(Some(WeightsType::LoRA)).weights_category(Some(WeightsCategory::ImageGeneration)).limit(10).scope_creator_username(Some("hanashi")).include_user_deleted_results(false).sort_ascending(true).cursor_is_reversed(false);
    ...
    let qb = ListWeightsQueryBuilder::new().offset(Some(0)).weights_type(Some(WeightsType::LoRA)).weights_category(Some(WeightsCategory::ImageGeneration)).limit(10).scope_creator_username(Some("hanashi")).include_user_deleted_results(false).sort_ascending(false).cursor_is_reversed(true);
    let result = qb.perform_query_for_page(&pool).await?;
  ...
  async fn list_weights_query_build_test_asc_desc() -> AnyhowResult<()> {
    ...
    let qb = ListWeightsQueryBuilder::new().offset(Some(0)).weights_type(Some(WeightsType::LoRA)).weights_category(Some(WeightsCategory::ImageGeneration)).limit(10).scope_creator_username(Some("hanashi")).include_user_deleted_results(false).sort_ascending(true);
    let result = qb.perform_query_for_page(&pool).await?;
    ...
    let qb = ListWeightsQueryBuilder::new().offset(Some(0)).weights_type(Some(WeightsType::LoRA)).weights_category(Some(WeightsCategory::ImageGeneration)).limit(10).scope_creator_username(Some("hanashi")).include_user_deleted_results(false).sort_ascending(false);
    let result = qb.perform_query_for_page(&pool).await?;
  ...
  async fn list_weights_query_build_test() -> AnyhowResult<()> {
    ...
    let qb = ListWeightsQueryBuilder::new().weights_type(Some(WeightsType::Tacotron2)).weights_category(Some(WeightsCategory::TextToSpeech)).scope_creator_username(Some("hanashi")).include_user_deleted_results(false);

    let result = qb.perform_query_for_page(&pool).await?;

    assert_eq!(result.weights.len(), 2);

    let qb = ListWeightsQueryBuilder::new().weights_type(Some(WeightsType::LoRA)).weights_category(Some(WeightsCategory::ImageGeneration)).scope_creator_username(Some("hanashi")).include_user_deleted_results(false);
  ...
  async fn list_weights_query_builder_page_type_and_category() -> AnyhowResult<()> {
    ...
    for i in 0..4 {
      let weights_types = vec![WeightsType::HifiganTacotron2, WeightsType::LoRA, WeightsType::RvcV2, WeightsType::StableDiffusionXL];

      let weights_type = weights_types[i as usize];

      let qb = ListWeightsQueryBuilder::new().weights_type(Some(weights_type)).scope_creator_username(Some("hanashi")).include_user_deleted_results(false);

      println!("weights_type: {:?}", weights_type);
      let result = qb.perform_query_for_page(&pool).await?;
      assert_eq!(result.weights.len(), 20, "Should be 20 weights");
      assert_eq!(result.weights[0].weights_type, weights_type, "Should be the same weights type");
    }
  ...
  async fn list_weight_query_builder_all() -> AnyhowResult<()> {
    ...
    let qb = ListWeightsQueryBuilder::new().scope_creator_username(Some("hanashi")).include_user_deleted_results(false).limit(11);
  ...
  async fn list_limits() -> AnyhowResult<()> {
    ...
    let qb = ListWeightsQueryBuilder::new().scope_creator_username(Some("hanashi")).include_user_deleted_results(false).weights_category(Some(WeightsCategory::ImageGeneration)).limit(10);
    ...
    let qb = ListWeightsQueryBuilder::new().scope_creator_username(Some("hanashi")).include_user_deleted_results(false);
    ...
    assert_eq!(result.weights[0].weights_category, WeightsCategory::ImageGeneration);
    // over query limit
    let qb: ListWeightsQueryBuilder = ListWeightsQueryBuilder::new().scope_creator_username(Some("hanashi")).include_user_deleted_results(false).weights_category(Some(WeightsCategory::ImageGeneration)).limit(80);
    let result = qb.perform_query_for_page(&pool).await?;
  ...
  async fn page_across_a_category() -> AnyhowResult<()> {
    ...
    let qb = ListWeightsQueryBuilder::new().scope_creator_username(Some("hanashi")).include_user_deleted_results(false).weights_category(Some(WeightsCategory::ImageGeneration)).sort_ascending(true).limit(page_size);
    ...
    let qb = ListWeightsQueryBuilder::new().scope_creator_username(Some("hanashi")).include_user_deleted_results(false).weights_category(Some(WeightsCategory::ImageGeneration)).limit(page_size).sort_ascending(true).offset(Some(offset.into()));
    ...
    let qb = ListWeightsQueryBuilder::new().scope_creator_username(Some("hanashi")).include_user_deleted_results(false).sort_ascending(true).weights_category(Some(WeightsCategory::ImageGeneration)).limit(page_size).offset(Some(offset.into()));
