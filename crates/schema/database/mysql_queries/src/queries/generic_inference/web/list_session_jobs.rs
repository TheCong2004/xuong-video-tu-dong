...
pub async fn list_session_jobs(args: ListSessionJobsForUserArgs<'_>, mysql_pool: &MySqlPool) -> AnyhowResult<Vec<GenericInferenceJobStatus>> {
...
/// Look up job status.
/// Returns Ok(Vec::new()) when the records cannot be found.
pub async fn list_session_jobs_from_connection(args: ListSessionJobsForUserArgs<'_>, mysql_connection: &mut PoolConnection<MySql>) -> AnyhowResult<Vec<GenericInferenceJobStatus>> {
