...
pub async fn mark_generic_inference_job_completely_failed(pool: &MySqlPool, job: &AvailableInferenceJob, maybe_public_failure_reason: Option<&str>, maybe_internal_debugging_failure_reason: Option<&str>, maybe_frontend_failure_category: Option<FrontendFailureCategory>) -> AnyhowResult<()> {
