...
/// A Grok (xAI) API job that is waiting for a result from the external API.
#[derive(Debug)]
pub struct PendingGrokApiJob {
  pub job_token: InferenceJobToken,

  /// The external `request_id` from xAI's video generation endpoint.
