...
pub async fn list_media_files(args: ListMediaFilesArgs<'_>) -> AnyhowResult<MediaFileListPage> {
  let mut query = query_builder(args.maybe_filter_media_types, args.maybe_filter_media_classes, args.maybe_filter_engine_categories, args.include_user_uploads, args.limit, args.maybe_offset, args.cursor_is_reversed, args.sort_ascending, args.view_as);
