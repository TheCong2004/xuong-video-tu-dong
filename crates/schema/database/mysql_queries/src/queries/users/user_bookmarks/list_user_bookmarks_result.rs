  ...
  pub fn into_public_type(self) -> UserBookmark {
    UserBookmark {
      ...
      maybe_entity_descriptive_text: match self.entity_type {
        ...
        UserBookmarkEntityType::MediaFile => self.maybe_media_file_type.and_then(|media_file_type| match media_file_type {
          ...
          MediaFileType::Ply => Some("3d splat".to_string()),
          ...
          MediaFileType::MoodJson => Some("mood board".to_string()),
          MediaFileType::TimelineJson => Some("video timeline".to_string()),
          MediaFileType::EditorJson => Some("2d editor project".to_string()),
          ...
          MediaFileType::Webp => Some("image media file".to_string()),
          MediaFileType::Mp4 => Some("video media file".to_string()),
          MediaFileType::Webm => Some("video media file".to_string()),
          MediaFileType::Mov => Some("video media file".to_string()),
          MediaFileType::Wav => Some("audio media file".to_string()),
          MediaFileType::Mp3 => Some("audio media file".to_string()),
          MediaFileType::Opus => Some("audio media file".to_string()),
          MediaFileType::Ogg => Some("audio media file".to_string()),
          MediaFileType::Aac => Some("audio media file".to_string()),
          MediaFileType::M4a => Some("audio media file".to_string()),
          MediaFileType::Flac => Some("audio media file".to_string()),
          MediaFileType::Json => Some("project file".to_string()),
        }),
