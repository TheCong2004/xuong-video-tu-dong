...
LIMIT 1
  ...
  // NB: fail open
  let _r = insert_audit_log(InsertAuditLogArgs { entity: &AuditLogEntity::User(args.subject_user_token.clone()), entity_action: AuditLogEntityAction::EditFeatures, maybe_actor_user_token: args.maybe_mod_user_token, maybe_actor_anonymous_visitor_token: None, actor_ip_address: &args.ip_address, is_actor_moderator: true, mysql_executor: args.mysql_pool, phantom: Default::default() }).await;
