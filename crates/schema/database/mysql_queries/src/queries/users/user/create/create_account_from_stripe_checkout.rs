...
pub async fn create_account_from_stripe_checkout<'e, 'c: 'e, E>(args: CreateAccountFromStripeCheckoutArgs<'_>, mysql_executor: E) -> Result<UserToken, CreateAccountError>
where
