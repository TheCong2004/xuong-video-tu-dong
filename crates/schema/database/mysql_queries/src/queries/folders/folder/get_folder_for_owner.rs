...
pub async fn get_folder_for_owner<'e, 'c: 'e, E>(args: GetFolderForOwnerArgs<'e, 'c, E>) -> Result<Option<FolderRow>, sqlx::Error>
where
  E: 'e + Executor<'c, Database = MySql>,
{
