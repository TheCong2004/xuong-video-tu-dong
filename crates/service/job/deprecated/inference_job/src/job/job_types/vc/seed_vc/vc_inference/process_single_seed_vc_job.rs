...
use crate::job::job_types::vc::seed_vc::seed_vc_inference_command::InferenceArgs;
use crate::job::job_types::vc::seed_vc::vc_inference::check_and_validate_job::check_and_validate_job;
...
use mysql_queries::queries::media_files::create::specialized_insert::insert_media_file_from_seed_vc::{insert_media_file_from_seed_vc, InsertSeedVcMediaFileArgs};
...
pub async fn process_single_seed_vc_inference_job(job_dependencies: &JobDependencies, job: &AvailableInferenceJob) -> Result<JobSuccessResult, ProcessSingleJobError> {
  ...
  let original_source_media_upload_fs_path = {
    ...
    let bucket_object_path = source_inference_media.get_bucket_path();
  ...
  let original_reference_media_upload_fs_path = {
    ...
    let bucket_object_path = reference_inference_media.get_bucket_path();
  ...
  let (media_file_token, id) = insert_media_file_from_seed_vc(InsertSeedVcMediaFileArgs {
