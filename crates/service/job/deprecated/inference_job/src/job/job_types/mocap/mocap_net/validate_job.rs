...
pub fn validate_job(job: &AvailableInferenceJob) -> Result<JobArgs, ProcessSingleJobError> {
  ...
  Ok(JobArgs { video_source, maybe_ik1: inference_args.maybe_ik1.as_ref(), maybe_ik2: inference_args.maybe_ik2.as_ref(), maybe_ik3: inference_args.maybe_ik3.as_ref(), maybe_smoothing1: inference_args.maybe_smoothing1.as_ref(), maybe_smoothing2: inference_args.maybe_smoothing2.as_ref(), maybe_size1: inference_args.maybe_size1.as_ref(), maybe_size2: inference_args.maybe_size2.as_ref() })
}
