...
pub fn resize_image<P: AsRef<Path>>(input_file: P, tempdir: &TempDir, new_width: u32, new_height: u32) -> AnyhowResult<PathBuf> {
  let image = resize_image_file_preserving_aspect(input_file, new_width, new_height, true)?;
