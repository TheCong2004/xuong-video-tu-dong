...
pub fn preprocess_save_audio(args: ProcessSaveAudioArgs<'_>) -> Result<(), ProcessSingleJobError> {
  ...
  let command_exit_status = args.comfy_deps.ffmpeg_command_runner.run_with_subprocess(RunAsSubprocessArgs { args: Box::new(&FfmpegExtractAudioArgs { input_video_file, output_file: &args.videos.primary_video.trimmed_wav_audio_path }), stderr: StreamRedirection::None, stdout: StreamRedirection::None });
