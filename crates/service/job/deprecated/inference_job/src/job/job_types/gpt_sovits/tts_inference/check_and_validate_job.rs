...
pub fn check_and_validate_job(job: &AvailableInferenceJob) -> Result<JobArgs, ProcessSingleJobError> {
  ...
  Ok(JobArgs { input_text, gpt_sovits_model, reference_free: None, temperature: None, target_language: None, maybe_truncate_seconds, maybe_append_advertisement: inference_args.append_advertisement.clone() })
}
