...
crate::impl_model_downloader!(RvcV2Rmvpe, "RVC (v2) RMVPE", "RVC_V2_RMVPE_CLOUD_PATH", "/dependencies/vc/rvc_v2/rmvpe.pt", "RVC_V2_RMVPE_FS_PATH", "/tmp/downloads/rvc_v2/rmvpe.pt");
...
impl RvcV2Downloaders {
  pub fn build_all_from_env() -> Self {
    Self { rmvpe: RvcV2Rmvpe::from_env() }
  }
