...
pub async fn upsert_subscription_details(details: &UpsertableSubscriptionDetails, crud_type: CrudType, transaction: &mut sqlx::Transaction<'_, sqlx::MySql>) -> anyhow::Result<()> {
