...
pub async fn require_moderator<'e, 'c: 'e, E>(http_request: &HttpRequest, session_checker: &SessionChecker, mysql_executor: E) -> Result<SessionUserRecord, CommonWebError>
where
