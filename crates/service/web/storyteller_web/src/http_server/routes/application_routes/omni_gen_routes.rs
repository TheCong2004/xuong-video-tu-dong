...
{
  app.service(
    web::scope("/v1/omni_gen")
      .service(web::scope("/cost").service(web::resource("/video").route(web::post().to(omni_gen_video_cost_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/image").route(web::post().to(omni_gen_image_cost_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/audio").route(web::post().to(omni_gen_audio_cost_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/mesh").route(web::post().to(omni_gen_mesh_cost_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/splat").route(web::post().to(omni_gen_splat_cost_handler)).route(web::head().to(|| HttpResponse::Ok()))))
      .service(web::scope("/generate").service(web::resource("/video").route(web::post().to(omni_gen_video_generate_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/image").route(web::post().to(omni_gen_image_generate_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/audio").route(web::post().to(omni_gen_audio_generate_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/mesh").route(web::post().to(omni_gen_mesh_generate_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/splat").route(web::post().to(omni_gen_splat_generate_handler)).route(web::head().to(|| HttpResponse::Ok()))))
      .service(web::scope("/models").service(web::resource("/video").route(web::get().to(omni_gen_video_models_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/image").route(web::get().to(omni_gen_image_models_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/audio").route(web::get().to(omni_gen_audio_models_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/mesh").route(web::get().to(omni_gen_mesh_models_handler)).route(web::head().to(|| HttpResponse::Ok()))).service(web::resource("/splat").route(web::get().to(omni_gen_splat_models_handler)).route(web::head().to(|| HttpResponse::Ok())))),
  )
}
