...
#[deprecated(note = "Use `media_files` instead of `media_uploads`.")]
pub async fn upload_audio_handler(http_request: HttpRequest, server_state: web::Data<Arc<ServerState>>, mut multipart_payload: Multipart) -> Result<HttpResponse, UploadError> {
