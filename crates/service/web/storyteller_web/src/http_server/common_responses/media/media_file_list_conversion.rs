...
/// in one place.
pub fn build_media_links_and_cover(row: &MediaFileListRow, media_domain: MediaDomain, server_environment: ServerEnvironment) -> (MediaLinks, MediaFileCoverImageDetails) {
