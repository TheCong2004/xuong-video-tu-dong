...
pub async fn log_app_active_user_json_handler(http_request: HttpRequest, request: Json<LogAppActiveUserRequest>, server_state: web::Data<Arc<ServerState>>) -> Result<Json<LogAppActiveUserResponse>, CommonWebError> {
