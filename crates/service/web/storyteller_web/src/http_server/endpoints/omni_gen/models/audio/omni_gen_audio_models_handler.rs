...
pub async fn omni_gen_audio_models_handler(_http_request: HttpRequest, _server_state: web::Data<Arc<ServerState>>) -> Result<Json<OmniGenAudioModelsResponse>, CommonWebError> {
