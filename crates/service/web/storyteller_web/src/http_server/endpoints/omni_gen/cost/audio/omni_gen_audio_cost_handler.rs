...
pub async fn omni_gen_audio_cost_handler(_http_request: HttpRequest, request: Json<OmniGenAudioCostAndGenerateRequest>, _server_state: web::Data<Arc<ServerState>>) -> Result<Json<OmniGenAudioCostResponse>, CommonWebError> {
