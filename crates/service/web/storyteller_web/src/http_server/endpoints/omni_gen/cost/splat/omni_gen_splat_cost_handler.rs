...
pub async fn omni_gen_splat_cost_handler(_http_request: HttpRequest, request: Json<OmniGenSplatCostAndGenerateRequest>, _server_state: web::Data<Arc<ServerState>>) -> Result<Json<OmniGenSplatCostResponse>, CommonWebError> {
