...
pub fn resolve_media_tokens_to_urls(builder: &mut GenerateMeshRequestBuilder, url_map: Option<&HashMap<MediaFileToken, String>>) {
...
fn resolve_image_ref(image_ref: &mut Option<ImageRef>, map: &HashMap<MediaFileToken, String>) {
