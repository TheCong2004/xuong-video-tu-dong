...
use artcraft_api_defs::omni_gen::models::omni_gen_video_models::{OmniGenVideoModelsQuery, OmniGenVideoModelsResponse};
...
pub async fn omni_gen_video_models_handler(_http_request: HttpRequest, _server_state: web::Data<Arc<ServerState>>, _query: Query<OmniGenVideoModelsQuery>) -> Result<Json<OmniGenVideoModelsResponse>, CommonWebError> {
...
pub async fn can_see_happy_horse(http_request: &HttpRequest, server_state: &ServerState) -> Result<bool, CommonWebError> {
