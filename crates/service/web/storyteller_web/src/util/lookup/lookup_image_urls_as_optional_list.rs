...
pub async fn lookup_image_urls_as_optional_list(http_request: &HttpRequest, mysql_connection: &mut PoolConnection<MySql>, server_environment: ServerEnvironment, tokens: &[MediaFileToken]) -> Result<Option<Vec<String>>, CommonWebError> {
