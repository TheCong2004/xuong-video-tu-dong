...
pub async fn lookup_media_file_urls_as_map(http_request: &HttpRequest, mysql_connection: &mut PoolConnection<MySql>, server_environment: ServerEnvironment, tokens: &[MediaFileToken]) -> Result<HashMap<MediaFileToken, Url>, CommonWebError> {
