...
pub async fn lookup_image_urls_as_map(http_request: &HttpRequest, mysql_connection: &mut PoolConnection<MySql>, server_environment: ServerEnvironment, tokens: &[MediaFileToken]) -> Result<HashMap<MediaFileToken, String>, CommonWebError> {
