...
/// Seedance 2.0 Mini, Seedance 2.0 BytePlus Mini, Seedance 2.0 BytePlus Ultra Mini.
pub fn seedance_2p0_video_models() -> Vec<OmniGenVideoModelDetails> {
  ...
  models.push(OmniGenVideoModelDetails {
    ...
    aspect_ratio_options: Some(vec![CommonAspectRatio::WideTwentyOneByNine, CommonAspectRatio::WideSixteenByNine, CommonAspectRatio::WideFourByThree, CommonAspectRatio::Square, CommonAspectRatio::TallThreeByFour, CommonAspectRatio::TallNineBySixteen]),
    aspect_ratio_default: Some(CommonAspectRatio::WideSixteenByNine),
    resolution_options: Some(vec![CommonResolution::FourEightyP, CommonResolution::SevenTwentyP, CommonResolution::TenEightyP, CommonResolution::FourK]),
    resolution_default: Some(CommonResolution::SevenTwentyP),
    bitrate_options: Some(vec![CommonBitrate::Normal, CommonBitrate::High]),
  ...
  models.push(OmniGenVideoModelDetails {
    model: CommonVideoModel::Seedance2p0Mini,
    model_creator: Some(ModelCreator::Bytedance),
    full_name: Some("Seedance 2.0 Mini".to_string()),
    extra_info: Some("The Chinese Volcengine (ByteDance China API platform) version of Seedance 2.0 Mini. This may be better at some characters than the other Seedance models.".to_string()),
    extra_info_short: Some("Chinese Volcengine Version".to_string()),
    text_prompt_supported: Some(true),
    text_prompt_max_length: Some(10_000),
    starting_keyframe_supported: Some(true),
    ending_keyframe_supported: Some(true),
  ...
  models.push(OmniGenVideoModelDetails {
    model: CommonVideoModel::Seedance2p0BytePlusMini,
    model_creator: Some(ModelCreator::Bytedance),
    full_name: Some("Seedance 2.0 Plus Mini".to_string()),
    extra_info: Some("The Chinese BytePlus (ByteDance's Western API platform) version of Seedance 2.0 Mini. This has fewer restrictions on faces and IP.".to_string()),
    extra_info_short: Some("BytePlus Version".to_string()),
    text_prompt_supported: Some(true),
    text_prompt_max_length: Some(10_000),
    starting_keyframe_supported: Some(true),
    ending_keyframe_supported: Some(true),
  ...
  models.push(OmniGenVideoModelDetails {
    model: CommonVideoModel::Seedance2p0BytePlusUltraMini,
    model_creator: Some(ModelCreator::Bytedance),
    full_name: Some("Seedance 2.0 Plus Ultra Mini".to_string()),
    extra_info: Some("This is the same BytePlus version of Seedance 2.0 Mini, but with even fewer restrictions around content. Horror movies, action movie violence, and more is possible.".to_string()),
    extra_info_short: Some("BytePlus Version".to_string()),
    text_prompt_supported: Some(true),
    text_prompt_max_length: Some(10_000),
    starting_keyframe_supported: Some(true),
