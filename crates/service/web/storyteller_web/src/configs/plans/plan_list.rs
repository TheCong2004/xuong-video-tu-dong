...
pub static FREE_LOGGED_OUT_PLAN: Lazy<Plan> = Lazy::new(|| PlanBuilder::new("free_logged_out").is_synthetic_plan(true).plan_category(PlanCategory::Free).tts_base_priority_level(FAKEYOU_ANONYMOUS_PRIORITY_LEVEL).tts_max_character_length(1024).web_vc_base_priority_level(FAKEYOU_ANONYMOUS_PRIORITY_LEVEL).web_vc_requires_frontend_keepalive(true).lipsync_requires_frontend_keepalive(true).build());
...
/// This is declared at the top level because it may need to be referenced directly.
pub static FREE_LOGGED_IN_PLAN: Lazy<Plan> = Lazy::new(|| PlanBuilder::new("free_logged_in").is_synthetic_plan(true).plan_category(PlanCategory::Free).tts_base_priority_level(FAKEYOU_LOGGED_IN_PRIORITY_LEVEL).tts_max_character_length(1024).web_vc_base_priority_level(FAKEYOU_LOGGED_IN_PRIORITY_LEVEL).web_vc_requires_frontend_keepalive(true).lipsync_requires_frontend_keepalive(true).build());
...
pub static LOYALTY_PLANS: Lazy<HashSet<Plan>> = Lazy::new(|| {
  ...
  plans.insert(PlanBuilder::new("fakeyou_contributor").is_synthetic_plan(true).plan_category(PlanCategory::LoyaltyReward).tts_base_priority_level(2).tts_max_character_length(2048).tts_max_duration_seconds(30).web_vc_base_priority_level(2).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).build());
...
pub static DEVELOPMENT_PREMIUM_PLANS: Lazy<HashSet<Plan>> = Lazy::new(|| {
  ...
  plans.insert(PlanBuilder::new("development_fakeyou_plus").is_development_plan(true).plan_category(PlanCategory::Paid).stripe_product_id("prod_MMxi2J5y69VPbO").stripe_price_id("price_1LeDnKEU5se17MekVr1iYYNf").cost_per_month_dollars(7).tts_base_priority_level(20).tts_max_character_length(2048).tts_max_duration_seconds(30).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).build());

  plans.insert(PlanBuilder::new("development_fakeyou_pro").is_development_plan(true).plan_category(PlanCategory::Paid).stripe_product_id("prod_MScAZa5uk5TfDY").stripe_price_id("price_1LjgwIEU5se17MekzQZUHl9W").cost_per_month_dollars(15).tts_base_priority_level(30).tts_max_character_length(2048).tts_max_duration_seconds(60 * 2).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).build());

  plans.insert(PlanBuilder::new("development_fakeyou_elite").is_development_plan(true).plan_category(PlanCategory::Paid).stripe_product_id("prod_MoFffbqBPt2NG5").stripe_price_id("price_1M4dAbEU5se17MekEmwnee41").cost_per_month_dollars(25).tts_base_priority_level(40).tts_max_character_length(2048).tts_max_duration_seconds(60 * 5).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).build());
...
pub static PRODUCTION_PREMIUM_PLANS: Lazy<HashSet<Plan>> = Lazy::new(|| {
  ...
  // Old "plus" price
  plans.insert(PlanBuilder::new("fakeyou_plus").plan_category(PlanCategory::Paid).stripe_product_id("prod_MoLv23HrxPiY7D").stripe_price_id("price_1M4jDCEU5se17MekOaJ92HYX").cost_per_month_dollars(7).tts_base_priority_level(20).tts_max_character_length(2048).tts_max_duration_seconds(30).web_vc_base_priority_level(20).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).build());

  // New "plus" price
  plans.insert(PlanBuilder::new("fakeyou_plus_plan").plan_category(PlanCategory::Paid).stripe_product_id("prod_RvC5qUgLTSLGSD").stripe_price_id("price_1R1Lh8EU5se17MekaUNtWc59").cost_per_month_dollars(12).tts_base_priority_level(20).tts_max_character_length(2048).tts_max_duration_seconds(30).web_vc_base_priority_level(20).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).build());

  // Old "pro" price
  plans.insert(PlanBuilder::new("fakeyou_pro").plan_category(PlanCategory::Paid).stripe_product_id("prod_MoLw8nA6eFxHzc").stripe_price_id("price_1M4jEQEU5se17MeksNfA0EKm").cost_per_month_dollars(15).tts_base_priority_level(30).tts_max_character_length(3072).tts_max_duration_seconds(60 * 2).web_vc_base_priority_level(30).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).can_remove_visual_watermarks(true).build());

  // New "pro" price
  plans.insert(PlanBuilder::new("fakeyou_pro_plan").plan_category(PlanCategory::Paid).stripe_product_id("prod_RvC6nB9rw6yAsI").stripe_price_id("price_1R1LhzEU5se17Mek3JLwN3Gg").cost_per_month_dollars(25).tts_base_priority_level(30).tts_max_character_length(3072).tts_max_duration_seconds(60 * 2).web_vc_base_priority_level(30).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).can_remove_visual_watermarks(true).build());

  // Old "elite" price
  plans.insert(PlanBuilder::new("fakeyou_elite").plan_category(PlanCategory::Paid).stripe_product_id("prod_MoLxQmLA4R24fv").stripe_price_id("price_1M4jFREU5se17Mekc8pQaSKB").cost_per_month_dollars(25).tts_base_priority_level(40).tts_max_character_length(4096).tts_max_duration_seconds(60 * 5).web_vc_base_priority_level(40).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).can_remove_visual_watermarks(true).build());

  // New "elite" price
  plans.insert(PlanBuilder::new("fakeyou_elite_plan").plan_category(PlanCategory::Paid).stripe_product_id("prod_RvC6i84YiAYStd").stripe_price_id("price_1R1LiQEU5se17MekiJdBcsHQ").cost_per_month_dollars(40).tts_base_priority_level(40).tts_max_character_length(4096).tts_max_duration_seconds(60 * 5).web_vc_base_priority_level(40).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).can_remove_visual_watermarks(true).build());

  // ========== Spanish plans ==========

  plans.insert(PlanBuilder::new("fakeyou_basic").plan_category(PlanCategory::Paid).stripe_product_id("prod_MoLyt8qMDmscjr").stripe_price_id("price_1M4jGPEU5se17Mek2FiztNE5").cost_per_month_dollars(3).tts_base_priority_level(10).web_vc_base_priority_level(10).web_vc_requires_frontend_keepalive(false).lipsync_requires_frontend_keepalive(false).tts_max_duration_seconds(30).build());
...
pub static PLANS_BY_STRIPE_PRODUCT_ID: Lazy<HashMap<String, Plan>> = Lazy::new(|| {
  ...
  ALL_PLANS_BY_SLUG.values().for_each(|plan| {
...
mod test {
  ...
  fn test_number_of_stripe_development_plans_is_expected() {
    let development_plans = ALL_PLANS_BY_SLUG.values().filter(|plan| plan.is_development_plan()).collect::<Vec<&Plan>>();
  ...
  fn test_plans_by_stripe_product_id_are_expected() {
    let product_ids = PLANS_BY_STRIPE_PRODUCT_ID.keys().map(|product_id| product_id.to_string()).collect::<Vec<String>>();
  ...
  fn test_plans_by_stripe_price_id_are_expected() {
    let price_ids = PLANS_BY_STRIPE_PRICE_ID.keys().map(|price_id| price_id.to_string()).collect::<Vec<String>>();
