...
pub async fn test_seed_weights_files() -> AnyhowResult<()> {
  ...
  let bucket_details1 = RemoteCloudBucketDetails { object_hash: String::from("apa0ej6es8d3ss2gwtf1cghge35qn9tn"), prefix: String::from("sd15_"), suffix: String::from(".safetensors") };

  let bucket_details2 = RemoteCloudBucketDetails { object_hash: String::from("27kz11et18fargyyxbj66ntfn621k9d3"), prefix: String::from("loRA_"), suffix: String::from(".safetensors") };
...
pub async fn seed_weights_for_user_token(mysql_pool: &Pool<MySql>, user_token: UserToken) -> AnyhowResult<()> {
