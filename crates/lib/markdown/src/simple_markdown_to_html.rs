...
pub fn simple_markdown_to_html(markdown_input: &str) -> String {
...
#[cfg(test)]
mod tests {
  use crate::simple_markdown_to_html::simple_markdown_to_html;

  #[test]
  fn handles_markdown() {
    assert_eq!(&simple_markdown_to_html("*italics text*"), "<p><em>italics text</em></p>\n");

    assert_eq!(&simple_markdown_to_html("**bold text**"), "<p><strong>bold text</strong></p>\n");
  }

  #[test]
  fn do_not_allow_html_entities() {
    assert_eq!(&simple_markdown_to_html("this > that"), "<p>this &gt; that</p>\n");

    assert_eq!(&simple_markdown_to_html("&"), "<p>&amp;</p>\n");
  ...
  fn do_not_allow_html_tags() {
    assert_eq!(&simple_markdown_to_html("<script>alert();</script>"), "<p>&lt;script&gt;alert();&lt;/script&gt;</p>\n");
  }
}
