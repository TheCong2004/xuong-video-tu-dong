...
macro_rules! weight {
  ($name: literal, $file_name:literal, $weight_function:expr) => {
    $crate::weights_registry::weight_descriptor::WeightDescriptor { name: $name, filename: $file_name, r2_download_url: const_format::concatcp!(crate::weights_registry::weight_descriptor_builder::R2_BUCKET_URL, $file_name), function: $weight_function }
  };
}
