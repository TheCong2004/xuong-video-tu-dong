...
pub async fn generate_seedream_5p0_pro(args: GenerateSeedream5p0ProArgs<'_>) -> Result<GenerateSeedream5p0ProResponse, Seedance2ProError> {
  let api_params = build_api_params(&args.request)?;

  let raw_response: WorkflowRunTaskResponse = workflow_run_task_custom(WorkflowRunTaskCustomArgs { business_type: BUSINESS_TYPE, api_params, session: args.session, host_override: args.host_override }).await?;

  Ok(GenerateSeedream5p0ProResponse { task_id: raw_response.task_id, order_id: raw_response.order_id, task_ids: raw_response.task_ids, order_ids: raw_response.order_ids })
}
...
fn build_api_params(request: &GenerateSeedream5p0ProRequest) -> Result<Seedream5p0ProApiParams, Seedance2ProClientError> {
  let uploaded_urls = match &request.reference_image_urls {
    Some(urls) if urls.len() > MAX_REFERENCE_IMAGES => {
      return Err(Seedance2ProClientError::InvalidRequestField { field: "reference_image_urls", raw_value: format!("{} urls", urls.len()), reason: format!("At most {} reference images are allowed", MAX_REFERENCE_IMAGES) });
    },
  ...
  Ok(Seedream5p0ProApiParams { prompt: request.prompt.clone(), aspect_ratio: request.aspect_ratio.as_api_str(), resolution: request.resolution.as_api_str(), model: MODEL, batch_count, uploaded_urls })
}
...
mod tests {
  ...
  fn base_request() -> GenerateSeedream5p0ProRequest {
    GenerateSeedream5p0ProRequest { prompt: "An anime girl riding a dinosaur".to_string(), aspect_ratio: KinoviSeedream5p0ProAspectRatio::Auto, resolution: KinoviSeedream5p0ProResolution::TwoK, batch_count: KinoviSeedream5p0ProBatchCount::One, reference_image_urls: None }
  }
  ...
  mod request_shape_tests {
    ...
    fn auto_2k_single_image() {
      ...
      assert_eq!(serde_json::to_string(&params).unwrap(), r#"{"prompt":"An anime girl riding a dinosaur","aspectRatio":"auto","resolution":"2k","model":"seedream-5.0-pro"}"#,);
    }

    /// Mirrors capture 2_seedream_5_21x9.txt (21:9, 2k, single image).
    #[test]
    fn ultra_wide_21x9_2k() {
      let params = build_api_params(&GenerateSeedream5p0ProRequest { prompt: "a pirate sailing a pirate ship".to_string(), aspect_ratio: KinoviSeedream5p0ProAspectRatio::UltraWide21x9, resolution: KinoviSeedream5p0ProResolution::TwoK, batch_count: KinoviSeedream5p0ProBatchCount::One, reference_image_urls: None }).unwrap();
      assert_eq!(serde_json::to_string(&params).unwrap(), r#"{"prompt":"a pirate sailing a pirate ship","aspectRatio":"21:9","resolution":"2k","model":"seedream-5.0-pro"}"#,);
    }
    ...
    fn portrait_9x16_1k_with_image_references() {
      let params = build_api_params(&GenerateSeedream5p0ProRequest { prompt: "The man in @Image1 is staring out the door in @Image2 ".to_string(), aspect_ratio: KinoviSeedream5p0ProAspectRatio::Portrait9x16, resolution: KinoviSeedream5p0ProResolution::OneK, batch_count: KinoviSeedream5p0ProBatchCount::One, reference_image_urls: Some(vec!["https://static.seedance2-pro.com/materials/20260713/1783904468032-0a803390.jpg".to_string(), "https://static.seedance2-pro.com/materials/20260713/1783904481112-4a3fa0d2.png".to_string()]) }).unwrap();
      assert_eq!(serde_json::to_string(&params).unwrap(), r#"{"prompt":"The man in @Image1 is staring out the door in @Image2 ","aspectRatio":"9:16","resolution":"1k","model":"seedream-5.0-pro","uploadedUrls":["https://static.seedance2-pro.com/materials/20260713/1783904468032-0a803390.jpg","https://static.seedance2-pro.com/materials/20260713/1783904481112-4a3fa0d2.png"]}"#,);
    }
    ...
    fn tall_2x3_2k_batch_four_with_image_references() {
      let params = build_api_params(&GenerateSeedream5p0ProRequest { prompt: "An anime girl is standing in the door @Image1 Outside the door, there's the galaxy and windmill @Image2 ".to_string(), aspect_ratio: KinoviSeedream5p0ProAspectRatio::Tall2x3, resolution: KinoviSeedream5p0ProResolution::TwoK, batch_count: KinoviSeedream5p0ProBatchCount::Four, reference_image_urls: Some(vec!["https://static.seedance2-pro.com/materials/20260713/1783904481112-4a3fa0d2.png".to_string(), "https://static.seedance2-pro.com/materials/20260713/1783904588294-5c713908.jpg".to_string()]) }).unwrap();
      assert_eq!(serde_json::to_string(&params).unwrap(), r#"{"prompt":"An anime girl is standing in the door @Image1 Outside the door, there's the galaxy and windmill @Image2 ","aspectRatio":"2:3","resolution":"2k","model":"seedream-5.0-pro","batchCount":4,"uploadedUrls":["https://static.seedance2-pro.com/materials/20260713/1783904481112-4a3fa0d2.png","https://static.seedance2-pro.com/materials/20260713/1783904588294-5c713908.jpg"]}"#,);
    }
    ...
    fn square_1x1_1k_batch_eight_with_image_references() {
      let params = build_api_params(&GenerateSeedream5p0ProRequest { prompt: "The mirror from @Image2 is in front of the windmill in @Image1 . The sky and galaxy are lit up at night. ".to_string(), aspect_ratio: KinoviSeedream5p0ProAspectRatio::Square1x1, resolution: KinoviSeedream5p0ProResolution::OneK, batch_count: KinoviSeedream5p0ProBatchCount::Eight, reference_image_urls: Some(vec!["https://static.seedance2-pro.com/materials/20260713/1783904715554-1a7ce415.jpg".to_string(), "https://static.seedance2-pro.com/materials/20260713/1783904719453-1d10e81f.png".to_string()]) }).unwrap();
      assert_eq!(serde_json::to_string(&params).unwrap(), r#"{"prompt":"The mirror from @Image2 is in front of the windmill in @Image1 . The sky and galaxy are lit up at night. ","aspectRatio":"1:1","resolution":"1k","model":"seedream-5.0-pro","batchCount":8,"uploadedUrls":["https://static.seedance2-pro.com/materials/20260713/1783904715554-1a7ce415.jpg","https://static.seedance2-pro.com/materials/20260713/1783904719453-1d10e81f.png"]}"#,);
    }

    #[test]
    fn every_aspect_ratio_wire_value() {
      let cases = [(KinoviSeedream5p0ProAspectRatio::Auto, "auto"), (KinoviSeedream5p0ProAspectRatio::Square1x1, "1:1"), (KinoviSeedream5p0ProAspectRatio::Standard4x3, "4:3"), (KinoviSeedream5p0ProAspectRatio::Portrait3x4, "3:4"), (KinoviSeedream5p0ProAspectRatio::Landscape16x9, "16:9"), (KinoviSeedream5p0ProAspectRatio::Portrait9x16, "9:16"), (KinoviSeedream5p0ProAspectRatio::Wide3x2, "3:2"), (KinoviSeedream5p0ProAspectRatio::Tall2x3, "2:3"), (KinoviSeedream5p0ProAspectRatio::UltraWide21x9, "21:9")];
    ...
    fn every_batch_count_value() {
      let cases = [(KinoviSeedream5p0ProBatchCount::One, 1), (KinoviSeedream5p0ProBatchCount::Two, 2), (KinoviSeedream5p0ProBatchCount::Three, 3), (KinoviSeedream5p0ProBatchCount::Four, 4), (KinoviSeedream5p0ProBatchCount::Five, 5), (KinoviSeedream5p0ProBatchCount::Six, 6), (KinoviSeedream5p0ProBatchCount::Seven, 7), (KinoviSeedream5p0ProBatchCount::Eight, 8)];
      for (variant, expected) in cases {
    ...
    fn empty_reference_list_omits_uploaded_urls() {
      let params = build_api_params(&GenerateSeedream5p0ProRequest { reference_image_urls: Some(vec![]), ..base_request() }).unwrap();
  ...
  mod reference_image_limit_tests {
    ...
    fn request_with_n_references(count: usize) -> GenerateSeedream5p0ProRequest {
      GenerateSeedream5p0ProRequest { reference_image_urls: Some((0..count).map(|i| format!("https://example.com/ref{i}.jpg")).collect()), ..base_request() }
    }
  }
  ...
  mod pricing_tests {
    ...
    fn reference_images_do_not_affect_cost() {
      ...
      let with_refs = GenerateSeedream5p0ProRequest { reference_image_urls: Some(vec!["https://example.com/ref1.jpg".to_string(), "https://example.com/ref2.jpg".to_string()]), ..request(KinoviSeedream5p0ProResolution::TwoK, KinoviSeedream5p0ProBatchCount::Four) }.calculate_costs();
    ...
    fn aspect_ratio_does_not_affect_cost() {
      ...
      let ultra_wide = GenerateSeedream5p0ProRequest { aspect_ratio: KinoviSeedream5p0ProAspectRatio::UltraWide21x9, ..request(KinoviSeedream5p0ProResolution::OneK, KinoviSeedream5p0ProBatchCount::One) }.calculate_costs();
      assert_eq!(auto, ultra_wide);
    }

    fn request(resolution: KinoviSeedream5p0ProResolution, batch_count: KinoviSeedream5p0ProBatchCount) -> GenerateSeedream5p0ProRequest {
      GenerateSeedream5p0ProRequest { resolution, batch_count, ..base_request() }
    }
  }
  ...
  mod live_tests {
    ...
    async fn test_text_to_image_2k() -> AnyhowResult<()> {
      ...
      let result = generate_seedream_5p0_pro(GenerateSeedream5p0ProArgs { session: &session, host_override: None, request: GenerateSeedream5p0ProRequest { prompt: "A corgi wearing a wizard hat, studio lighting".to_string(), aspect_ratio: KinoviSeedream5p0ProAspectRatio::Auto, resolution: KinoviSeedream5p0ProResolution::TwoK, batch_count: KinoviSeedream5p0ProBatchCount::One, reference_image_urls: None } }).await?;
    ...
    async fn test_text_to_image_1k_with_references() -> AnyhowResult<()> {
      setup_test_logging(LevelFilter::Trace);
      let session = test_session()?;
      let result = generate_seedream_5p0_pro(GenerateSeedream5p0ProArgs { session: &session, host_override: None, request: GenerateSeedream5p0ProRequest { prompt: "The man in @Image1 is staring out the door in @Image2".to_string(), aspect_ratio: KinoviSeedream5p0ProAspectRatio::Portrait9x16, resolution: KinoviSeedream5p0ProResolution::OneK, batch_count: KinoviSeedream5p0ProBatchCount::One, reference_image_urls: Some(vec!["https://static.seedance2-pro.com/materials/20260713/1783904468032-0a803390.jpg".to_string(), "https://static.seedance2-pro.com/materials/20260713/1783904481112-4a3fa0d2.png".to_string()]) } }).await?;
    ...
    async fn test_batch_four_1k() -> AnyhowResult<()> {
      setup_test_logging(LevelFilter::Trace);
      let session = test_session()?;
      let result = generate_seedream_5p0_pro(GenerateSeedream5p0ProArgs { session: &session, host_override: None, request: GenerateSeedream5p0ProRequest { prompt: "A lighthouse on a cliff at golden hour".to_string(), aspect_ratio: KinoviSeedream5p0ProAspectRatio::Landscape16x9, resolution: KinoviSeedream5p0ProResolution::OneK, batch_count: KinoviSeedream5p0ProBatchCount::Four, reference_image_urls: None } }).await?;
