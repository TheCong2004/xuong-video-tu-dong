...
use crate::requests_old::http::image::edit::http_nano_banana_pro_edit_image::{nano_banana_pro_edit_image, NanoBananaProEditImageInput};
use crate::requests::core_api::webhook_response::WebhookResponse;
use reqwest::IntoUrl;

pub struct EnqueueNanoBananaProEditImageArgs<'a, R: IntoUrl> {
  pub request: EnqueueNanoBananaProEditImageRequest,
  pub webhook_url: R,
  pub api_key: &'a FalApiKey,
}

#[derive(Clone, Debug)]
pub struct EnqueueNanoBananaProEditImageRequest {
  pub prompt: String,
