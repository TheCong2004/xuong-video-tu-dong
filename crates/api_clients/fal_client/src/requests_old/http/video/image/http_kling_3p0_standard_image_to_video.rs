...
pub fn kling_3p0_standard_image_to_video(params: Kling3p0StandardImageToVideoInput) -> FalRequest<Kling3p0StandardImageToVideoInput, Kling3p0StandardImageToVideoOutput> {
