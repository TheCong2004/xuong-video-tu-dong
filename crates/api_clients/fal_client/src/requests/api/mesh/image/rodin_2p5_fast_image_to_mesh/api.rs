...
use crate::requests::api::mesh::image::rodin_2p5_fast_image_to_mesh::raw_request::{Rodin2p5FastImageToMeshInput, Rodin2p5FastImageToMeshOutput};
use crate::requests::api::mesh::text::rodin_2p5_fast_text_to_mesh::api::{Rodin2p5FastGeometryFileFormat, Rodin2p5FastMaterial, Rodin2p5FastQualityMeshOption, Rodin2p5FastTextureMode, Rodin2p5FastTier};
...
mod tests {
  ...
  fn base_request() -> Rodin2p5FastImageToMeshRequest {
    Rodin2p5FastImageToMeshRequest { image_urls: vec!["https://example.com/input.jpg".to_string()], prompt: None, use_original_alpha: None, tier: None, seed: None, geometry_file_format: None, material: None, quality_mesh_option: None, texture_mode: None, enable_creative_mode: None, hd_texture: None, texture_delight: None, is_micro: None, ta_pose: None, bbox_condition: None, preview_render: None }
  }
  ...
  async fn test_image_to_mesh_webhook() -> AnyhowResult<()> {
    ...
    let request = Rodin2p5FastImageToMeshRequest { image_urls: vec![ERNEST_SCARED_STUPID_IMAGE_URL.to_string()], ..base_request() };
  ...
  fn raw_request_maps_core_fields() {
    let request = Rodin2p5FastImageToMeshRequest { prompt: Some("a robot".to_string()), use_original_alpha: Some(true), tier: Some(Rodin2p5FastTier::Minimum), quality_mesh_option: Some(Rodin2p5FastQualityMeshOption::Triangle20k), ta_pose: Some(true), preview_render: Some(true), ..base_request() };
  ...
  fn raw_request_omits_unset_optionals() {
    ...
    assert_eq!(json, serde_json::json!({ "image_urls": ["https://example.com/input.jpg"] }),);
  }
