...
use crate::requests::api::mesh::image::hunyuan_3d_2p0_image_to_mesh::raw_request::{Hunyuan3d2p0ImageToMeshInput, Hunyuan3d2p0ImageToMeshOutput};
...
mod tests {
  ...
  async fn test_image_to_mesh_webhook() -> AnyhowResult<()> {
    ...
    let request = Hunyuan3d2p0ImageToMeshRequest { image_url: ERNEST_SCARED_STUPID_IMAGE_URL.to_string(), textured_mesh: Some(true), guidance_scale: None, num_inference_steps: None, octree_resolution: None, seed: None };
  ...
  fn raw_request_maps_all_fields() {
    let request = Hunyuan3d2p0ImageToMeshRequest { image_url: "https://example.com/image.jpg".to_string(), textured_mesh: Some(true), guidance_scale: Some(5.0), num_inference_steps: Some(30), octree_resolution: Some(512), seed: Some(42) };
  ...
  fn raw_request_omits_unset_optionals() {
    let request = Hunyuan3d2p0ImageToMeshRequest { image_url: "https://example.com/image.jpg".to_string(), textured_mesh: None, guidance_scale: None, num_inference_steps: None, octree_resolution: None, seed: None };
    let json = serde_json::to_value(request.to_raw_request().unwrap()).unwrap();
