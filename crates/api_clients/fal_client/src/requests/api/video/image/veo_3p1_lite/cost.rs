use crate::requests::api::video::image::veo_3p1_lite::api::{Veo3p1LiteImageToVideoDuration, Veo3p1LiteImageToVideoRequest, Veo3p1LiteImageToVideoResolution};
...
impl FalRequestCostCalculator for Veo3p1LiteImageToVideoRequest {
  fn calculate_cost_in_cents(&self) -> UsdCents {
    ...
    let duration_secs = self.duration.unwrap_or(Veo3p1LiteImageToVideoDuration::EightSeconds).to_seconds();
    let is_1080p = self.resolution.unwrap_or(Veo3p1LiteImageToVideoResolution::SevenTwentyP).is_ten_eighty_p();
...
mod tests {
  ...
  fn make_request(duration: Option<Veo3p1LiteImageToVideoDuration>, resolution: Option<Veo3p1LiteImageToVideoResolution>, generate_audio: Option<bool>) -> Veo3p1LiteImageToVideoRequest {
    Veo3p1LiteImageToVideoRequest { prompt: "test".to_string(), image_url: "https://example.com/x.png".to_string(), aspect_ratio: None, duration, resolution, generate_audio, negative_prompt: None, seed: None, auto_fix: None, safety_tolerance: None }
  }
  ...
  mod cost_table {
    ...
    const COST_TABLE: &[(Option<Veo3p1LiteImageToVideoDuration>, Option<Veo3p1LiteImageToVideoResolution>, Option<bool>, u64)] = &[
    ...
    fn cost_is_independent_of_aspect_ratio() {
      ...
      for ar in [Veo3p1LiteImageToVideoAspectRatio::Auto, Veo3p1LiteImageToVideoAspectRatio::SixteenByNine, Veo3p1LiteImageToVideoAspectRatio::NineBySixteen] {
        let mut r = make_request(Some(Veo3p1LiteImageToVideoDuration::EightSeconds), Some(Veo3p1LiteImageToVideoResolution::TenEightyP), Some(true));
