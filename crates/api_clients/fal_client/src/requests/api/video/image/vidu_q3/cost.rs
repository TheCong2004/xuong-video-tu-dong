...
// Image-to-video shares the Vidu Q3 per-second pricing (see the text module for
// the canonical rate table):
//   360p / 540p:  $0.07/sec
//   720p / 1080p: $0.154/sec  (2.2×)
// Pricing depends on resolution and duration only.

impl FalRequestCostCalculator for ViduQ3ImageToVideoRequest {
