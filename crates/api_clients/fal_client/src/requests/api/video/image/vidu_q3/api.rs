...
use crate::requests::api::video::image::vidu_q3::raw_request::{ViduQ3ImageToVideoInput, ViduQ3ImageToVideoOutput};
use crate::requests::traits::fal_endpoint_trait::FalEndpoint;

#[derive(Clone, Debug)]
pub struct ViduQ3ImageToVideoRequest {
  ...
  pub resolution: Option<ViduQ3ImageToVideoResolution>,
...
pub enum ViduQ3ImageToVideoResolution {
  ThreeSixtyP,
  FiveFortyP,
  SevenTwentyP,
  TenEightyP,
...
impl ViduQ3ImageToVideoResolution {
...
impl FalEndpoint for ViduQ3ImageToVideoRequest {
  const ENDPOINT: &str = "fal-ai/vidu/q3/image-to-video";

  type RawRequest = ViduQ3ImageToVideoInput;
  type RawResponse = ViduQ3ImageToVideoOutput;
...
mod tests {
  ...
  async fn test_image_to_video_webhook() -> AnyhowResult<()> {
    ...
    let request = ViduQ3ImageToVideoRequest { prompt: "the lake comes alive with gentle ripples and dappled sunlight".to_string(), image_url: JUNO_AT_LAKE_IMAGE_URL.to_string(), end_image_url: None, duration: Some(5), seed: None, resolution: Some(ViduQ3ImageToVideoResolution::SevenTwentyP), audio: Some(false) };
  ...
  fn raw_request_maps_all_fields() {
    let request = ViduQ3ImageToVideoRequest { prompt: "p".to_string(), image_url: "https://example.com/start.png".to_string(), end_image_url: Some("https://example.com/end.png".to_string()), duration: Some(7), seed: Some(42), resolution: Some(ViduQ3ImageToVideoResolution::TenEightyP), audio: Some(false) };
  ...
  fn raw_request_omits_unset_optionals() {
    let request = ViduQ3ImageToVideoRequest { prompt: "p".to_string(), image_url: "https://example.com/start.png".to_string(), end_image_url: None, duration: None, seed: None, resolution: None, audio: None };
  ...
  fn seed_serializes_when_set() {
    let request = ViduQ3ImageToVideoRequest { prompt: "p".to_string(), image_url: "https://example.com/start.png".to_string(), end_image_url: None, duration: None, seed: Some(777), resolution: None, audio: None };
    let json = serde_json::to_value(request.to_raw_request().unwrap()).unwrap();
  ...
  fn endpoint_path_is_canonical() {
    assert_eq!(ViduQ3ImageToVideoRequest::ENDPOINT, "fal-ai/vidu/q3/image-to-video",);
  }
