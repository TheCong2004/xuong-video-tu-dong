...
use crate::requests::api::video::image::veo_3p1_fast::raw_request::{Veo3p1FastImageToVideoInput, Veo3p1FastImageToVideoOutput};
...
mod tests {
  ...
  async fn test_image_to_video_webhook() -> AnyhowResult<()> {
    ...
    let request = Veo3p1FastImageToVideoRequest { prompt: "the lake comes alive with gentle ripples and dappled sunlight".to_string(), image_url: JUNO_AT_LAKE_IMAGE_URL.to_string(), aspect_ratio: Some(Veo3p1FastImageToVideoAspectRatio::SixteenByNine), duration: Some(Veo3p1FastImageToVideoDuration::FourSeconds), resolution: Some(Veo3p1FastImageToVideoResolution::SevenTwentyP), generate_audio: Some(false), negative_prompt: None, seed: None, auto_fix: None, safety_tolerance: None };
  ...
  async fn test_image_to_video_queue() -> AnyhowResult<()> {
    ...
    let request = Veo3p1FastImageToVideoRequest { prompt: "wind moves through the trees".to_string(), image_url: JUNO_AT_LAKE_IMAGE_URL.to_string(), aspect_ratio: None, duration: Some(Veo3p1FastImageToVideoDuration::FourSeconds), resolution: Some(Veo3p1FastImageToVideoResolution::SevenTwentyP), generate_audio: Some(false), negative_prompt: None, seed: None, auto_fix: None, safety_tolerance: None };
  ...
  fn raw_request_maps_all_fields() {
    let request = Veo3p1FastImageToVideoRequest { prompt: "p".to_string(), image_url: "https://example.com/start.png".to_string(), aspect_ratio: Some(Veo3p1FastImageToVideoAspectRatio::Auto), duration: Some(Veo3p1FastImageToVideoDuration::SixSeconds), resolution: Some(Veo3p1FastImageToVideoResolution::TenEightyP), generate_audio: Some(false), negative_prompt: Some("nope".to_string()), seed: Some(7), auto_fix: Some(true), safety_tolerance: Some(Veo3p1FastImageToVideoSafetyTolerance::Level2) };
  ...
  fn raw_request_omits_unset_optionals() {
    let request = Veo3p1FastImageToVideoRequest { prompt: "p".to_string(), image_url: "https://example.com/start.png".to_string(), aspect_ratio: None, duration: None, resolution: None, generate_audio: None, negative_prompt: None, seed: None, auto_fix: None, safety_tolerance: None };
  ...
  fn every_aspect_ratio_maps_to_wire_string() {
    for (variant, expected) in [(Veo3p1FastImageToVideoAspectRatio::Auto, "auto"), (Veo3p1FastImageToVideoAspectRatio::SixteenByNine, "16:9"), (Veo3p1FastImageToVideoAspectRatio::NineBySixteen, "9:16")] {
  ...
  fn endpoint_path_is_canonical() {
    assert_eq!(Veo3p1FastImageToVideoRequest::ENDPOINT, "fal-ai/veo3.1/fast/image-to-video",);
  }
