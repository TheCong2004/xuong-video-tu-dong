use crate::requests::api::video::image::veo_3_fast::api::{Veo3FastImageToVideoDuration, Veo3FastImageToVideoRequest};
use crate::requests::api::video::text::veo_3_fast::cost::{veo_3_fast_cost_cents, veo_3_fast_rate_tenth_cents_per_sec};
...
impl FalRequestCostCalculator for Veo3FastImageToVideoRequest {
  fn calculate_cost_in_cents(&self) -> UsdCents {
    ...
    let duration_secs = self.duration.unwrap_or(Veo3FastImageToVideoDuration::EightSeconds).to_seconds();
...
mod tests {
  ...
  fn make_request(duration: Option<Veo3FastImageToVideoDuration>, generate_audio: Option<bool>) -> Veo3FastImageToVideoRequest {
    Veo3FastImageToVideoRequest { prompt: "test".to_string(), image_url: "https://example.com/x.png".to_string(), aspect_ratio: None, duration, resolution: None, generate_audio, negative_prompt: None, seed: None, auto_fix: None, safety_tolerance: None }
  }
  ...
  mod cost_table {
    ...
    const COST_TABLE: &[(Option<Veo3FastImageToVideoDuration>, Option<bool>, u64)] = &[
    ...
    fn cost_is_independent_of_aspect_ratio() {
      ...
      for ar in [Veo3FastImageToVideoAspectRatio::Auto, Veo3FastImageToVideoAspectRatio::SixteenByNine, Veo3FastImageToVideoAspectRatio::NineBySixteen] {
        let mut r = make_request(Some(Veo3FastImageToVideoDuration::EightSeconds), Some(true));
