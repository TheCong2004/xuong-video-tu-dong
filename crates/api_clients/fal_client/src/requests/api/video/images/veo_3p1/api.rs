...
#[derive(Clone, Debug)]
pub struct Veo3p1FirstLastFrameToVideoRequest {
  ...
  pub aspect_ratio: Option<Veo3p1FirstLastFrameToVideoAspectRatio>,

  /// Video duration. fal's default is `8s` when `None`.
  pub duration: Option<Veo3p1FirstLastFrameToVideoDuration>,

  /// Output resolution. fal's default is `720p` when `None`.
  pub resolution: Option<Veo3p1FirstLastFrameToVideoResolution>,
  ...
  pub safety_tolerance: Option<Veo3p1FirstLastFrameToVideoSafetyTolerance>,
}

#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1FirstLastFrameToVideoAspectRatio {
  Auto,
  SixteenByNine,
  NineBySixteen,
}

impl Veo3p1FirstLastFrameToVideoAspectRatio {
...
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1FirstLastFrameToVideoDuration {
  FourSeconds,
  SixSeconds,
  EightSeconds,
}

impl Veo3p1FirstLastFrameToVideoDuration {
...
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1FirstLastFrameToVideoResolution {
  SevenTwentyP,
  TenEightyP,
  FourK,
}

impl Veo3p1FirstLastFrameToVideoResolution {
...
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1FirstLastFrameToVideoSafetyTolerance {
  /// "1" — strictest.
  Level1,
  Level2,
  Level3,
...
impl Veo3p1FirstLastFrameToVideoSafetyTolerance {
  fn to_str(&self) -> &'static str {
    match self {
      Self::Level1 => "1",
      Self::Level2 => "2",
...
impl FalEndpoint for Veo3p1FirstLastFrameToVideoRequest {
  const ENDPOINT: &str = "fal-ai/veo3.1/first-last-frame-to-video";

  type RawRequest = Veo3p1FirstLastFrameToVideoInput;
