use crate::requests::api::video::images::veo_3p1_lite::api::{Veo3p1LiteFirstLastFrameToVideoDuration, Veo3p1LiteFirstLastFrameToVideoRequest, Veo3p1LiteFirstLastFrameToVideoResolution};
use crate::requests::api::video::text::veo_3p1_lite::cost::{veo_3p1_lite_cost_cents, veo_3p1_lite_rate_tenth_cents_per_sec};
...
impl FalRequestCostCalculator for Veo3p1LiteFirstLastFrameToVideoRequest {
  fn calculate_cost_in_cents(&self) -> UsdCents {
    ...
    let duration_secs = self.duration.unwrap_or(Veo3p1LiteFirstLastFrameToVideoDuration::EightSeconds).to_seconds();
    let is_1080p = self.resolution.unwrap_or(Veo3p1LiteFirstLastFrameToVideoResolution::SevenTwentyP).is_ten_eighty_p();
...
mod tests {
  ...
  fn make_request(duration: Option<Veo3p1LiteFirstLastFrameToVideoDuration>, resolution: Option<Veo3p1LiteFirstLastFrameToVideoResolution>, generate_audio: Option<bool>) -> Veo3p1LiteFirstLastFrameToVideoRequest {
    Veo3p1LiteFirstLastFrameToVideoRequest { prompt: "test".to_string(), first_frame_url: "https://example.com/first.png".to_string(), last_frame_url: "https://example.com/last.png".to_string(), aspect_ratio: None, duration, resolution, generate_audio, negative_prompt: None, seed: None, auto_fix: None, safety_tolerance: None }
  }
  ...
  mod cost_table {
    ...
    const COST_TABLE: &[(Option<Veo3p1LiteFirstLastFrameToVideoDuration>, Option<Veo3p1LiteFirstLastFrameToVideoResolution>, Option<bool>, u64)] = &[
