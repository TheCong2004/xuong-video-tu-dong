...
use crate::requests::api::video::reference::veo_3p1_fast::raw_request::{Veo3p1FastReferenceToVideoInput, Veo3p1FastReferenceToVideoOutput};
...
mod tests {
  ...
  async fn test_reference_to_video_webhook() -> AnyhowResult<()> {
    ...
    let request = Veo3p1FastReferenceToVideoRequest { prompt: "the two dogs run side by side across a sunlit meadow".to_string(), image_urls: vec![TALL_MOCHI_WITH_GLASSES_IMAGE_URL.to_string(), JUNO_AT_LAKE_IMAGE_URL.to_string()], aspect_ratio: Some(Veo3p1FastReferenceToVideoAspectRatio::SixteenByNine), duration: Some(Veo3p1FastReferenceToVideoDuration::FourSeconds), resolution: Some(Veo3p1FastReferenceToVideoResolution::SevenTwentyP), generate_audio: Some(false), auto_fix: None, safety_tolerance: None };
  ...
  async fn test_reference_to_video_queue() -> AnyhowResult<()> {
    ...
    let request = Veo3p1FastReferenceToVideoRequest { prompt: "the dogs play together in a snowy field".to_string(), image_urls: vec![TALL_MOCHI_WITH_GLASSES_IMAGE_URL.to_string()], aspect_ratio: None, duration: Some(Veo3p1FastReferenceToVideoDuration::FourSeconds), resolution: Some(Veo3p1FastReferenceToVideoResolution::SevenTwentyP), generate_audio: Some(false), auto_fix: None, safety_tolerance: None };
  ...
  fn raw_request_maps_all_fields() {
    let request = Veo3p1FastReferenceToVideoRequest { prompt: "p".to_string(), image_urls: vec!["https://example.com/a.png".to_string(), "https://example.com/b.png".to_string()], aspect_ratio: Some(Veo3p1FastReferenceToVideoAspectRatio::NineBySixteen), duration: Some(Veo3p1FastReferenceToVideoDuration::SixSeconds), resolution: Some(Veo3p1FastReferenceToVideoResolution::FourK), generate_audio: Some(true), auto_fix: Some(false), safety_tolerance: Some(Veo3p1FastReferenceToVideoSafetyTolerance::Level5) };
  ...
  fn raw_request_omits_unset_optionals() {
    let request = Veo3p1FastReferenceToVideoRequest { prompt: "p".to_string(), image_urls: vec!["https://example.com/a.png".to_string()], aspect_ratio: None, duration: None, resolution: None, generate_audio: None, auto_fix: None, safety_tolerance: None };
  ...
  fn raw_request_never_emits_negative_prompt_or_seed() {
    let request = Veo3p1FastReferenceToVideoRequest { prompt: "p".to_string(), image_urls: vec!["https://example.com/a.png".to_string()], aspect_ratio: Some(Veo3p1FastReferenceToVideoAspectRatio::SixteenByNine), duration: Some(Veo3p1FastReferenceToVideoDuration::EightSeconds), resolution: Some(Veo3p1FastReferenceToVideoResolution::TenEightyP), generate_audio: Some(true), auto_fix: Some(true), safety_tolerance: Some(Veo3p1FastReferenceToVideoSafetyTolerance::Level4) };
    let json = serde_json::to_value(request.to_raw_request().unwrap()).unwrap();
  ...
  fn endpoint_path_is_canonical() {
    assert_eq!(Veo3p1FastReferenceToVideoRequest::ENDPOINT, "fal-ai/veo3.1/fast/reference-to-video",);
  }
