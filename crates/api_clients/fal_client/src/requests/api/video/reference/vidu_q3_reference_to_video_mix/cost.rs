use crate::requests::api::video::reference::vidu_q3_reference_to_video_mix::api::{ViduQ3ReferenceToVideoMixRequest, ViduQ3ReferenceToVideoMixResolution};
...
impl FalRequestCostCalculator for ViduQ3ReferenceToVideoMixRequest {
  fn calculate_cost_in_cents(&self) -> UsdCents {
    ...
    let is_high_res = self.resolution.unwrap_or(ViduQ3ReferenceToVideoMixResolution::SevenTwentyP).is_high_res();
...
mod tests {
  ...
  fn make_request(duration: Option<u8>, resolution: Option<ViduQ3ReferenceToVideoMixResolution>) -> ViduQ3ReferenceToVideoMixRequest {
    ViduQ3ReferenceToVideoMixRequest { prompt: "test".to_string(), reference_image_urls: vec!["https://example.com/a.png".to_string()], duration, seed: None, aspect_ratio: None, resolution, audio: Some(true) }
  }
  ...
  mod cost_table {
    ...
    fn cost_is_independent_of_image_count() {
      ...
      let four = ViduQ3ReferenceToVideoMixRequest { reference_image_urls: vec!["https://example.com/a.png".to_string(), "https://example.com/b.png".to_string(), "https://example.com/c.png".to_string(), "https://example.com/d.png".to_string()], ..make_request(Some(8), Some(ViduQ3ReferenceToVideoMixResolution::SevenTwentyP)) }.calculate_cost_in_cents();
      assert_eq!(one, four);
    }
  }
}
