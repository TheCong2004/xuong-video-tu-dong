...
use crate::requests::api::video::reference::vidu_q3_reference_to_video::raw_request::{ViduQ3ReferenceToVideoInput, ViduQ3ReferenceToVideoOutput};
...
mod tests {
  ...
  async fn test_reference_to_video_webhook() -> AnyhowResult<()> {
    ...
    let request = ViduQ3ReferenceToVideoRequest { prompt: "the two dogs run side by side across a sunlit meadow".to_string(), reference_image_urls: vec![TALL_MOCHI_WITH_GLASSES_IMAGE_URL.to_string(), JUNO_AT_LAKE_IMAGE_URL.to_string()], duration: Some(5), seed: None, aspect_ratio: Some(ViduQ3ReferenceToVideoAspectRatio::SixteenByNine), resolution: Some(ViduQ3ReferenceToVideoResolution::SevenTwentyP), audio: Some(false) };
  ...
  async fn test_reference_to_video_queue() -> AnyhowResult<()> {
    ...
    let request = ViduQ3ReferenceToVideoRequest { prompt: "the dogs play together in a snowy field".to_string(), reference_image_urls: vec![TALL_MOCHI_WITH_GLASSES_IMAGE_URL.to_string()], duration: Some(5), seed: Some(1234), aspect_ratio: None, resolution: Some(ViduQ3ReferenceToVideoResolution::ThreeSixtyP), audio: Some(false) };
  ...
  fn raw_request_maps_all_fields() {
    let request = ViduQ3ReferenceToVideoRequest { prompt: "p".to_string(), reference_image_urls: vec!["https://example.com/a.png".to_string(), "https://example.com/b.png".to_string()], duration: Some(12), seed: Some(42), aspect_ratio: Some(ViduQ3ReferenceToVideoAspectRatio::FourByThree), resolution: Some(ViduQ3ReferenceToVideoResolution::TenEightyP), audio: Some(false) };
  ...
  fn raw_request_omits_unset_optionals() {
    let request = ViduQ3ReferenceToVideoRequest { prompt: "p".to_string(), reference_image_urls: vec!["https://example.com/a.png".to_string()], duration: None, seed: None, aspect_ratio: None, resolution: None, audio: None };
  ...
  fn seed_serializes_when_set() {
    let request = ViduQ3ReferenceToVideoRequest { prompt: "p".to_string(), reference_image_urls: vec!["https://example.com/a.png".to_string()], duration: None, seed: Some(777), aspect_ratio: None, resolution: None, audio: None };
    let json = serde_json::to_value(request.to_raw_request().unwrap()).unwrap();
  ...
  fn every_aspect_ratio_maps_to_wire_string() {
    for (variant, expected) in [(ViduQ3ReferenceToVideoAspectRatio::SixteenByNine, "16:9"), (ViduQ3ReferenceToVideoAspectRatio::NineBySixteen, "9:16"), (ViduQ3ReferenceToVideoAspectRatio::FourByThree, "4:3"), (ViduQ3ReferenceToVideoAspectRatio::ThreeByFour, "3:4"), (ViduQ3ReferenceToVideoAspectRatio::Square, "1:1")] {
  ...
  fn endpoint_path_is_canonical() {
    assert_eq!(ViduQ3ReferenceToVideoRequest::ENDPOINT, "fal-ai/vidu/q3/reference-to-video",);
  }
