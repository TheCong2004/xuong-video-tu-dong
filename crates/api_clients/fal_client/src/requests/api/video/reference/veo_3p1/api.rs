...
#[derive(Clone, Debug)]
pub struct Veo3p1ReferenceToVideoRequest {
  ...
  pub aspect_ratio: Option<Veo3p1ReferenceToVideoAspectRatio>,

  /// Video duration. fal's default is `8s` when `None`.
  pub duration: Option<Veo3p1ReferenceToVideoDuration>,

  /// Output resolution. fal's default is `720p` when `None`.
  pub resolution: Option<Veo3p1ReferenceToVideoResolution>,
  ...
  pub safety_tolerance: Option<Veo3p1ReferenceToVideoSafetyTolerance>,
}

#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1ReferenceToVideoAspectRatio {
  SixteenByNine,
  NineBySixteen,
}

impl Veo3p1ReferenceToVideoAspectRatio {
...
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1ReferenceToVideoDuration {
  FourSeconds,
  SixSeconds,
  EightSeconds,
}

impl Veo3p1ReferenceToVideoDuration {
...
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1ReferenceToVideoResolution {
  SevenTwentyP,
  TenEightyP,
  FourK,
}

impl Veo3p1ReferenceToVideoResolution {
...
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1ReferenceToVideoSafetyTolerance {
  /// "1" — strictest.
  Level1,
  Level2,
  Level3,
...
impl Veo3p1ReferenceToVideoSafetyTolerance {
  fn to_str(&self) -> &'static str {
    match self {
      Self::Level1 => "1",
      Self::Level2 => "2",
...
impl FalEndpoint for Veo3p1ReferenceToVideoRequest {
  const ENDPOINT: &str = "fal-ai/veo3.1/reference-to-video";

  type RawRequest = Veo3p1ReferenceToVideoInput;
