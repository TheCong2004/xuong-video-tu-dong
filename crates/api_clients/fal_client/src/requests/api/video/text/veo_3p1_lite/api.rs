...
use crate::requests::api::video::text::veo_3p1_lite::raw_request::{Veo3p1LiteTextToVideoInput, Veo3p1LiteTextToVideoOutput};
...
mod tests {
  ...
  async fn test_text_to_video_queue() -> AnyhowResult<()> {
    ...
    let request = Veo3p1LiteTextToVideoRequest { prompt: "a wave crashes against a rocky shoreline at sunset".to_string(), aspect_ratio: Some(Veo3p1LiteTextToVideoAspectRatio::SixteenByNine), duration: Some(Veo3p1LiteTextToVideoDuration::FourSeconds), resolution: Some(Veo3p1LiteTextToVideoResolution::SevenTwentyP), negative_prompt: None, generate_audio: Some(false), seed: None, auto_fix: None, safety_tolerance: None };
  ...
  fn raw_request_omits_unset_optionals() {
    let request = Veo3p1LiteTextToVideoRequest { prompt: "minimal".to_string(), aspect_ratio: None, duration: None, resolution: None, negative_prompt: None, generate_audio: None, seed: None, auto_fix: None, safety_tolerance: None };
  ...
  fn every_duration_maps_to_wire_string_and_seconds() {
    for (variant, s, secs) in [(Veo3p1LiteTextToVideoDuration::FourSeconds, "4s", 4), (Veo3p1LiteTextToVideoDuration::SixSeconds, "6s", 6), (Veo3p1LiteTextToVideoDuration::EightSeconds, "8s", 8)] {
  ...
  fn every_resolution_maps_to_wire_string() {
    for (variant, expected, hd) in [(Veo3p1LiteTextToVideoResolution::SevenTwentyP, "720p", false), (Veo3p1LiteTextToVideoResolution::TenEightyP, "1080p", true)] {
