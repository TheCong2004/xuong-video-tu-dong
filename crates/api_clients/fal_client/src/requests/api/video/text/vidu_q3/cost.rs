use crate::requests::api::video::text::vidu_q3::api::{ViduQ3TextToVideoRequest, ViduQ3TextToVideoResolution};
...
impl FalRequestCostCalculator for ViduQ3TextToVideoRequest {
  fn calculate_cost_in_cents(&self) -> UsdCents {
    ...
    let is_high_res = self.resolution.unwrap_or(ViduQ3TextToVideoResolution::SevenTwentyP).is_high_res();
...
mod tests {
  ...
  fn make_request(duration: Option<u8>, resolution: Option<ViduQ3TextToVideoResolution>, audio: Option<bool>) -> ViduQ3TextToVideoRequest {
    ViduQ3TextToVideoRequest { prompt: "test".to_string(), duration, seed: None, aspect_ratio: Some(ViduQ3TextToVideoAspectRatio::SixteenByNine), resolution, audio }
  }
  ...
  mod cost_table {
    ...
    fn cost_ignores_audio_and_aspect_ratio() {
      ...
      for audio in [None, Some(false), Some(true)] {
        for ar in [ViduQ3TextToVideoAspectRatio::SixteenByNine, ViduQ3TextToVideoAspectRatio::Square, ViduQ3TextToVideoAspectRatio::ThreeByFour] {
          let cost = ViduQ3TextToVideoRequest { aspect_ratio: Some(ar), ..make_request(Some(8), Some(ViduQ3TextToVideoResolution::SevenTwentyP), audio) }.calculate_cost_in_cents();
