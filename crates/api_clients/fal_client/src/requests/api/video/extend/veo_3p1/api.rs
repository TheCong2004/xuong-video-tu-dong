...
use crate::requests::api::video::extend::veo_3p1::raw_request::{Veo3p1ExtendVideoInput, Veo3p1ExtendVideoOutput};
use crate::requests::traits::fal_endpoint_trait::FalEndpoint;

#[derive(Clone, Debug)]
pub struct Veo3p1ExtendVideoRequest {
  ...
  pub aspect_ratio: Option<Veo3p1ExtendVideoAspectRatio>,

  /// Extension duration. fal's default is `7s` when `None`.
  pub duration: Option<Veo3p1ExtendVideoDuration>,

  /// Output resolution. fal's default is `720p` when `None`.
  pub resolution: Option<Veo3p1ExtendVideoResolution>,
  ...
  pub safety_tolerance: Option<Veo3p1ExtendVideoSafetyTolerance>,
}

#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1ExtendVideoAspectRatio {
  Auto,
  SixteenByNine,
  NineBySixteen,
}

impl Veo3p1ExtendVideoAspectRatio {
...
/// (no explicit enum). We expose `7s` plus the standard Veo 3.1 family
/// durations (`4s`/`6s`/`8s`) so callers stay strongly typed; if fal rejects
/// a value, trim this enum.
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1ExtendVideoDuration {
  FourSeconds,
  SixSeconds,
...
impl Veo3p1ExtendVideoDuration {
...
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1ExtendVideoResolution {
  SevenTwentyP,
  TenEightyP,
}

impl Veo3p1ExtendVideoResolution {
  fn to_str(&self) -> &'static str {
    match self {
...
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum Veo3p1ExtendVideoSafetyTolerance {
  /// "1" — strictest.
  Level1,
  Level2,
  Level3,
...
impl Veo3p1ExtendVideoSafetyTolerance {
  fn to_str(&self) -> &'static str {
    match self {
      Self::Level1 => "1",
      Self::Level2 => "2",
...
impl FalEndpoint for Veo3p1ExtendVideoRequest {
  const ENDPOINT: &str = "fal-ai/veo3.1/extend-video";

  type RawRequest = Veo3p1ExtendVideoInput;
  type RawResponse = Veo3p1ExtendVideoOutput;
...
mod tests {
  ...
  async fn test_extend_video_webhook() -> AnyhowResult<()> {
    ...
    let request = Veo3p1ExtendVideoRequest { prompt: "the scene continues naturally, keeping the same motion and style".to_string(), video_url: ANGRY_SHIBA_VIDEO_URL.to_string(), aspect_ratio: None, duration: Some(Veo3p1ExtendVideoDuration::SevenSeconds), resolution: Some(Veo3p1ExtendVideoResolution::SevenTwentyP), negative_prompt: None, generate_audio: Some(false), seed: None, auto_fix: None, safety_tolerance: None };
  ...
  async fn test_extend_video_queue() -> AnyhowResult<()> {
    ...
    let request = Veo3p1ExtendVideoRequest { prompt: "the camera pulls back to reveal more of the landscape".to_string(), video_url: ANGRY_SHIBA_VIDEO_URL.to_string(), aspect_ratio: None, duration: Some(Veo3p1ExtendVideoDuration::SevenSeconds), resolution: Some(Veo3p1ExtendVideoResolution::SevenTwentyP), negative_prompt: None, generate_audio: Some(false), seed: None, auto_fix: None, safety_tolerance: None };
  ...
  fn raw_request_maps_all_fields() {
    let request = Veo3p1ExtendVideoRequest { prompt: "p".to_string(), video_url: "https://example.com/in.mp4".to_string(), aspect_ratio: Some(Veo3p1ExtendVideoAspectRatio::SixteenByNine), duration: Some(Veo3p1ExtendVideoDuration::SevenSeconds), resolution: Some(Veo3p1ExtendVideoResolution::TenEightyP), negative_prompt: Some("nope".to_string()), generate_audio: Some(true), seed: Some(3), auto_fix: Some(false), safety_tolerance: Some(Veo3p1ExtendVideoSafetyTolerance::Level4) };
  ...
  fn raw_request_omits_unset_optionals() {
    let request = Veo3p1ExtendVideoRequest { prompt: "p".to_string(), video_url: "https://example.com/in.mp4".to_string(), aspect_ratio: None, duration: None, resolution: None, negative_prompt: None, generate_audio: None, seed: None, auto_fix: None, safety_tolerance: None };
  ...
  fn every_duration_maps_to_wire_string_and_seconds() {
    for (variant, s, secs) in [(Veo3p1ExtendVideoDuration::FourSeconds, "4s", 4), (Veo3p1ExtendVideoDuration::SixSeconds, "6s", 6), (Veo3p1ExtendVideoDuration::SevenSeconds, "7s", 7), (Veo3p1ExtendVideoDuration::EightSeconds, "8s", 8)] {
  ...
  fn endpoint_path_is_canonical() {
    assert_eq!(Veo3p1ExtendVideoRequest::ENDPOINT, "fal-ai/veo3.1/extend-video",);
  }
