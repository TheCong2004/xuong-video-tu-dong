...
mod tests {
  ...
  async fn test_single() -> AnyhowResult<()> {
    ...
    let request = Flux2LoraEditImageAngleRequest { image_urls: vec![JUNO_AT_LAKE_IMAGE_URL.to_string()], horizontal_angle: Some(45.0), vertical_angle: Some(15.0), zoom: Some(5.0), num_images: Some(Flux2LoraAngleNumImages::One), image_size: Some(Flux2LoraAngleImageSize::SquareHd), lora_scale: None, guidance_scale: None, num_inference_steps: None };
    ...
    for &h in &horizontal_angles {
      for &v in &vertical_angles {
        for &z in &zoom_levels {
          let request = Flux2LoraEditImageAngleRequest { image_urls: vec![JUNO_AT_LAKE_IMAGE_URL.to_string()], horizontal_angle: Some(h), vertical_angle: Some(v), zoom: Some(z), num_images: Some(Flux2LoraAngleNumImages::One), image_size: Some(Flux2LoraAngleImageSize::SquareHd), lora_scale: None, guidance_scale: None, num_inference_steps: None };
