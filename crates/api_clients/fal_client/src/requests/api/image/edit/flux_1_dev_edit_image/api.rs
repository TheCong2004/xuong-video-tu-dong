...
impl FalEndpoint for Flux1DevEditImageRequest {
  const ENDPOINT: &str = "fal-ai/flux/dev/image-to-image";

  type RawRequest = Flux1DevEditImageInput;
  type RawResponse = Flux1DevEditImageOutput;
