...
mod tests {
  ...
  fn options_do_not_change_cost() {
    let request = TripoSplatImageToSplatRequest { num_gaussians: Some(32_768), num_inference_steps: Some(50), guidance_scale: Some(10.0), output_format: Some(TripoSplatOutputFormat::Splat), seed: Some(7), enable_safety_checker: Some(false), ..base_request() };
