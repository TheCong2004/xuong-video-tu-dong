...
static CLEAN_NON_DIGIT_REGEX: Lazy<Regex> = Lazy::new(|| Regex::new(r#"[^\d]+"#).expect("Regex should parse"));
...
mod tests {
  ...
  fn test() {
    ...
    let expected = vec![vec![147, 16, 51, 222, 136, 87, 31, 177, 77, 40, 114], vec![68, 166, 18, 188, 114, 44, 220, 148, 210, 202, 25], vec![220, 36, 246, 218, 12, 120, 244, 34, 154, 56, 161], vec![211, 204, 208, 60, 174, 14, 155, 157, 116, 220, 95], vec![116, 164, 53, 210, 174, 232, 139, 148, 151, 135, 221], vec![167, 196, 118, 27, 149, 247, 233, 129, 238, 113, 21], vec![73, 44, 215, 158, 218, 29, 68, 13, 98, 243, 134], vec![44, 98, 149, 35, 20, 178, 163, 219, 104, 41, 152], vec![237, 107, 118, 120, 127, 117, 57, 41, 167, 43, 136], vec![116, 168, 44, 246, 182, 209, 143, 238, 93, 237, 119], vec![142, 36, 64, 67, 97, 111, 71, 230, 247, 119, 27], vec![206, 56, 158, 51, 71, 115, 135, 120, 186, 74, 57], vec![197, 165, 180, 214, 102, 16, 88, 252, 48, 189, 166], vec![163, 237, 57, 253, 154, 60, 96, 84, 56, 15, 66], vec![177, 101, 10, 202, 185, 227, 29, 204, 55, 115, 219], vec![103, 82, 127, 143, 194, 99, 102, 179, 63, 84, 110]];
