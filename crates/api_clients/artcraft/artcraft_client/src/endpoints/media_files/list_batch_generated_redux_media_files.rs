...
pub async fn list_batch_generated_redux_media_files(api_host: &ApiHost, maybe_creds: Option<&StorytellerCredentialSet>, batch_token: &BatchGenerationToken) -> Result<ListBatchGeneratedReduxMediaFilesSuccessResponse, StorytellerError> {
