...
impl StorytellerCredentialSet {
  pub fn empty() -> Self {
    Self { avt: None, session: None }
  }

  pub fn initialize(avt: Option<StorytellerAvtCookie>, session: Option<StorytellerSessionCookie>) -> Self {
    Self { avt, session }
  }
  ...
  pub fn initialize_with_just_cookie(session: StorytellerSessionCookie) -> Self {
    Self { avt: None, session: Some(session) }
  }

  pub fn initialize_with_just_avt(avt: StorytellerAvtCookie) -> Self {
    Self { avt: Some(avt), session: None }
  }
...
mod tests {
  ...
  mod cookies_header {
    ...
    fn avt_cookies_header() {
      let creds = StorytellerCredentialSet::initialize_with_just_avt(StorytellerAvtCookie::new("bob".to_string()));
    ...
    fn session_cookies_header() {
      let creds = StorytellerCredentialSet::initialize_with_just_cookie(StorytellerSessionCookie::new("bob".to_string()));
    ...
    fn both_cookies_header() {
      let creds = StorytellerCredentialSet::initialize(Some(StorytellerAvtCookie::new("bob".to_string())), Some(StorytellerSessionCookie::new("alice".to_string())));
