use fal_client::requests::api::mesh::image::hunyuan_3d_3p1_pro_image_to_mesh::api::Hunyuan3d3p1ProImageToMeshRequest;
use fal_client::requests::api::mesh::text::hunyuan_3d_3p1_pro_text_to_mesh::api::Hunyuan3d3p1ProTextToMeshRequest;
...
#[derive(Clone, Debug)]
pub struct FalHunyuan3d3p1ProImageRequestState {
  /// Final materialized request; ready to fire.
  pub request: Hunyuan3d3p1ProImageToMeshRequest,
}

impl FalHunyuan3d3p1ProImageRequestState {
...
#[derive(Clone, Debug)]
pub struct FalHunyuan3d3p1ProTextRequestState {
  /// Final materialized request; ready to fire.
  pub request: Hunyuan3d3p1ProTextToMeshRequest,
}

impl FalHunyuan3d3p1ProTextRequestState {
  pub async fn send(&self, client: &RouterFalClient) -> Result<GenerateMeshResponse, ArtcraftRouterError> {
    send_fal_mesh_request(&self.request, client).await
  }
}
