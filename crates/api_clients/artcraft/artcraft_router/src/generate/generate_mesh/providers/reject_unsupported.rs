...
pub(crate) fn reject_unsupported_image_ref(field: &'static str, image_ref: Option<&ImageRef>, strategy: RequestMismatchMitigationStrategy) -> Result<(), ArtcraftRouterError> {
