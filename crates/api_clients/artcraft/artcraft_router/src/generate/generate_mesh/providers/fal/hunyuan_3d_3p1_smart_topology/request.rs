use fal_client::requests::api::mesh::topology::hunyuan_3d_3p1_smart_topology::api::Hunyuan3d3p1SmartTopologyRequest;
...
#[derive(Clone, Debug)]
pub struct FalHunyuan3d3p1SmartTopologyRequestState {
  /// Final materialized request; ready to fire.
  pub request: Hunyuan3d3p1SmartTopologyRequest,
}

impl FalHunyuan3d3p1SmartTopologyRequestState {
