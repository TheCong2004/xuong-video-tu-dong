...
pub fn build_artcraft_sora_2(mut builder: GenerateVideoRequestBuilder) -> Result<VideoGenerationDraftOrRequest, ArtcraftRouterError> {
  ...
  let request = build_artcraft_omni_video_request(builder, CommonVideoModelEnum::Sora2, SupportedResolutions::Full, UltraWideSupport::Unsupported)?;
...
pub(crate) fn plan_sora_2_duration(duration_seconds: Option<u16>, strategy: RequestMismatchMitigationStrategy) -> Result<Option<u16>, ArtcraftRouterError> {
