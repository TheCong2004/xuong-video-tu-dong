...
pub fn build_artcraft_veo_3p1(mut builder: GenerateVideoRequestBuilder) -> Result<VideoGenerationDraftOrRequest, ArtcraftRouterError> {
  ...
  let mut request = build_artcraft_omni_video_request(builder, CommonVideoModelEnum::Veo3p1, SupportedResolutions::FullWith4k, UltraWideSupport::Unsupported)?;
...
pub(crate) fn plan_veo_3p1_duration(duration_seconds: Option<u16>, strategy: RequestMismatchMitigationStrategy) -> Result<Option<u16>, ArtcraftRouterError> {
