...
pub fn build_artcraft_veo_2(mut builder: GenerateVideoRequestBuilder) -> Result<VideoGenerationDraftOrRequest, ArtcraftRouterError> {
  ...
  let request = build_artcraft_omni_video_request(builder, CommonVideoModelEnum::Veo2, SupportedResolutions::Full, UltraWideSupport::Unsupported)?;
...
fn plan_veo_2_duration(duration_seconds: Option<u16>, strategy: RequestMismatchMitigationStrategy) -> Result<Option<u16>, ArtcraftRouterError> {
