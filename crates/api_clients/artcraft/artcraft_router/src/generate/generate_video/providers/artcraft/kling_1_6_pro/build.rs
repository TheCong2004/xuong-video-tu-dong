...
pub fn build_artcraft_kling_1_6_pro(mut builder: GenerateVideoRequestBuilder) -> Result<VideoGenerationDraftOrRequest, ArtcraftRouterError> {
  ...
  let request = build_artcraft_omni_video_request(builder, CommonVideoModelEnum::Kling16Pro, SupportedResolutions::Full, UltraWideSupport::Unsupported)?;
...
/// (PayLessDowngrade).
fn plan_kling_1_6_pro_duration(duration_seconds: Option<u16>, strategy: RequestMismatchMitigationStrategy) -> Result<Option<u16>, ArtcraftRouterError> {
