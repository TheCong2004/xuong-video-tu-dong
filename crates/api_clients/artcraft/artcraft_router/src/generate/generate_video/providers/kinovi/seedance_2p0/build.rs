use seedance2pro_client::generate::video::generate_seedance_2p0::{KinoviSeedance2p0AspectRatio as KinoviAspectRatio, KinoviSeedance2p0Bitrate as KinoviBitrate, KinoviSeedance2p0BatchCount as KinoviBatchCount, KinoviSeedance2p0OutputResolution as KinoviOutputResolution};
...
fn do_build_kinovi_seedance_2p0(mut builder: GenerateVideoRequestBuilder) -> Result<KinoviSeedance2p0DraftState, ArtcraftRouterError> {
  ...
  Ok(KinoviSeedance2p0DraftState { aspect_ratio, resolution, batch_count, duration_seconds, bitrate, prompt, unhandled_request_state: Some(unhandled_request_state) })
}
...
#[cfg(test)]
mod tests {
  use seedance2pro_client::generate::video::generate_seedance_2p0::{KinoviSeedance2p0AspectRatio as KinoviAspectRatio, KinoviSeedance2p0BatchCount as KinoviBatchCount, KinoviSeedance2p0OutputResolution as KinoviOutputResolution};
  ...
  mod materialized_field_conversions {
    ...
    fn duration_clamped_to_max() {
      let builder = GenerateVideoRequestBuilder { duration_seconds: Some(99), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
  ...
  mod aspect_ratio_conversions {
    ...
    fn aspect_ratio_wide() {
      let builder = GenerateVideoRequestBuilder { aspect_ratio: Some(RouterAspectRatio::WideSixteenByNine), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
    ...
    fn aspect_ratio_tall() {
      let builder = GenerateVideoRequestBuilder { aspect_ratio: Some(RouterAspectRatio::TallNineBySixteen), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
    ...
    fn aspect_ratio_square() {
      let builder = GenerateVideoRequestBuilder { aspect_ratio: Some(RouterAspectRatio::Square), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
  ...
  mod resolution_conversions {
    ...
    #[test]
    fn resolution_480p() {
      let builder = GenerateVideoRequestBuilder { resolution: Some(RouterResolution::FourEightyP), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
    ...
    #[test]
    fn resolution_720p() {
      let builder = GenerateVideoRequestBuilder { resolution: Some(RouterResolution::SevenTwentyP), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
    ...
    #[test]
    fn resolution_1080p() {
      let builder = GenerateVideoRequestBuilder { resolution: Some(RouterResolution::TenEightyP), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
    ...
    #[test]
    fn resolution_4k() {
      let builder = GenerateVideoRequestBuilder { resolution: Some(RouterResolution::FourK), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
    ...
    fn unsupported_resolution_error_out() {
      let builder = GenerateVideoRequestBuilder { resolution: Some(RouterResolution::ThreeK), request_mismatch_mitigation_strategy: RequestMismatchMitigationStrategy::ErrorOut, ..seedance2pro_builder() };
      assert!(build_kinovi_seedance_2p0(builder).is_err());
    }

    #[test]
    fn unsupported_resolution_rounds_up() {
      let builder = GenerateVideoRequestBuilder { resolution: Some(RouterResolution::ThreeK), request_mismatch_mitigation_strategy: RequestMismatchMitigationStrategy::PayMoreUpgrade, ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
      assert!(matches!(draft.resolution, Some(KinoviOutputResolution::TenEightyP)));
    }
  }
  ...
  mod bitrate_conversions {
    ...
    #[test]
    fn bitrate_high() {
      let builder = GenerateVideoRequestBuilder { bitrate: Some(RouterBitrate::High), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
    ...
    fn bitrate_normal_maps_to_standard() {
      let builder = GenerateVideoRequestBuilder { bitrate: Some(RouterBitrate::Normal), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
  ...
  mod unhandled_request_state {
    ...
    fn start_frame_placed_in_unhandled() {
      let builder = GenerateVideoRequestBuilder { start_frame: Some(ImageRef::Url("https://example.com/start.jpg".to_string())), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
    ...
    fn end_frame_placed_in_unhandled() {
      let builder = GenerateVideoRequestBuilder { end_frame: Some(ImageRef::Url("https://example.com/end.jpg".to_string())), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
      let remaining = draft.unhandled_request_state.unwrap();
    ...
    fn start_frame_media_token_placed_in_unhandled() {
      let builder = GenerateVideoRequestBuilder { start_frame: Some(ImageRef::MediaFileToken(MediaFileToken::new("mf_test123".to_string()))), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
      let remaining = draft.unhandled_request_state.unwrap();
    ...
    fn reference_images_placed_in_unhandled() {
      let builder = GenerateVideoRequestBuilder { reference_images: Some(ImageListRef::Urls(vec!["https://example.com/ref1.jpg".to_string(), "https://example.com/ref2.jpg".to_string()])), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
      let remaining = draft.unhandled_request_state.unwrap();
    ...
    fn reference_videos_placed_in_unhandled() {
      let builder = GenerateVideoRequestBuilder { reference_videos: Some(VideoListRef::Urls(vec!["https://example.com/vid.mp4".to_string()])), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
      let remaining = draft.unhandled_request_state.unwrap();
    ...
    fn reference_audio_placed_in_unhandled() {
      let builder = GenerateVideoRequestBuilder { reference_audio: Some(AudioListRef::Urls(vec!["https://example.com/audio.mp3".to_string()])), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
      let remaining = draft.unhandled_request_state.unwrap();
    ...
    fn character_tokens_placed_in_unhandled() {
      let builder = GenerateVideoRequestBuilder { reference_character_tokens: Some(CharacterListRef::CharacterTokens(vec![CharacterToken::new("char_abc".to_string()), CharacterToken::new("char_def".to_string())])), ..seedance2pro_builder() };
      let draft = unwrap_draft(build_kinovi_seedance_2p0(builder));
      let remaining = draft.unhandled_request_state.unwrap();
