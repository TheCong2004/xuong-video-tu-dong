...
#[derive(Clone, Debug)]
pub struct ArtcraftSeedance2p0BytePlusUltraMiniRequestState {
  pub request: OmniGenVideoCostAndGenerateRequest,
}

impl ArtcraftSeedance2p0BytePlusUltraMiniRequestState {
...
mod tests {
  ...
  fn mini_builder() -> GenerateVideoRequestBuilder {
    GenerateVideoRequestBuilder { model: RouterVideoModel::Seedance2p0BytePlusUltraMini, provider: RouterProvider::Artcraft, duration_seconds: Some(4), video_batch_count: Some(1), ..Default::default() }
  }
