...
mod tests {
  ...
  fn build_cost(resolution: Option<RouterResolution>, duration_seconds: u16, video_batch_count: u16, with_video_reference: bool) -> VideoGenerationCostEstimate {
    ...
    let builder = GenerateVideoRequestBuilder { model: RouterVideoModel::Seedance2p0BytePlusUltraMini, provider: RouterProvider::Artcraft, resolution, duration_seconds: Some(duration_seconds), video_batch_count: Some(video_batch_count), reference_videos, ..Default::default() };
