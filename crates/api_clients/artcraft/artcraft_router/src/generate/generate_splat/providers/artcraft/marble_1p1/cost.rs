...
/// Marble 1.1 via Artcraft is flat priced by input type.
#[derive(Clone, Debug)]
pub struct ArtcraftMarble1p1CostState {
  pub input_type: InputType,
}

impl ArtcraftMarble1p1CostState {
  pub fn from_request(request: &ArtcraftMarble1p1RequestState) -> Self {
...
mod tests {
  ...
  fn base_builder() -> GenerateSplatRequestBuilder {
    GenerateSplatRequestBuilder { model: RouterSplatModel::Marble1p1, provider: RouterProvider::Artcraft, ..Default::default() }
  }
