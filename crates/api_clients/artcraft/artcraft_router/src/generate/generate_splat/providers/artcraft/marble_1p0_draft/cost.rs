...
const PRICES: ArtcraftSplatPriceTable = ArtcraftSplatPriceTable { image_panorama: 16, text: 24, image_non_panorama: 24, multi_image: 26, video: 26 };
...
mod tests {
  ...
  fn base_builder() -> GenerateSplatRequestBuilder {
    GenerateSplatRequestBuilder { model: RouterSplatModel::Marble1p0Draft, provider: RouterProvider::Artcraft, ..Default::default() }
  }
