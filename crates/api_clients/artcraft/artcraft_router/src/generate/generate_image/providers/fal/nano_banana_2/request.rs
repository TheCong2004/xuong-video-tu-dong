...
mod tests {
  ...
  use fal_client::requests::api::image::edit::nano_banana_2_edit_image::api::{NanoBanana2EditImageAspectRatio, NanoBanana2EditImageNumImages, NanoBanana2EditImageResolution};
  use fal_client::requests::api::image::text::nano_banana_2_text_to_image::api::{NanoBanana2TextToImageAspectRatio, NanoBanana2TextToImageNumImages, NanoBanana2TextToImageResolution};
  ...
  mod text_to_image {
    ...
    fn t2i_request() -> FalNanoBanana2RequestState {
      FalNanoBanana2RequestState::TextToImage(NanoBanana2TextToImageRequest { prompt: "a corgi wearing sunglasses on a surfboard".to_string(), num_images: NanoBanana2TextToImageNumImages::One, resolution: Some(NanoBanana2TextToImageResolution::OneK), aspect_ratio: Some(NanoBanana2TextToImageAspectRatio::SixteenByNine) })
    }
  ...
  mod edit_image {
    ...
    fn edit_request() -> FalNanoBanana2RequestState {
      FalNanoBanana2RequestState::EditImage(NanoBanana2EditImageRequest { prompt: "add a party hat to the dog, and put the dog in front of the location".to_string(), image_urls: vec![JUNO_AT_LAKE_IMAGE_URL.to_string(), WHITE_HOUSE_SUNSET_IMAGE_URL.to_string()], num_images: NanoBanana2EditImageNumImages::One, resolution: Some(NanoBanana2EditImageResolution::OneK), aspect_ratio: Some(NanoBanana2EditImageAspectRatio::SixteenByNine) })
    }
