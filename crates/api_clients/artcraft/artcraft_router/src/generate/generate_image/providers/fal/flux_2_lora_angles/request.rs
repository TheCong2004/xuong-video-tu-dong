...
use fal_client::requests::api::image::angle::flux_2_lora_edit_image_angle::api::Flux2LoraEditImageAngleRequest;
...
pub struct FalFlux2LoraAnglesRequestState {
  pub request: Flux2LoraEditImageAngleRequest,
}
...
mod tests {
  ...
  use fal_client::requests::api::image::angle::flux_2_lora_edit_image_angle::api::{Flux2LoraAngleImageSize, Flux2LoraAngleNumImages};
  ...
  async fn send_via_webhook() {
    ...
    let state = FalFlux2LoraAnglesRequestState { request: Flux2LoraEditImageAngleRequest { image_urls: vec![JUNO_AT_LAKE_IMAGE_URL.to_string()], horizontal_angle: Some(45.0), vertical_angle: Some(15.0), zoom: Some(2.0), num_images: Some(Flux2LoraAngleNumImages::One), image_size: Some(Flux2LoraAngleImageSize::SquareHd), lora_scale: None, guidance_scale: None, num_inference_steps: None } };
