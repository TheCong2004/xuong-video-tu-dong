...
pub fn build_artcraft_flux_1_schnell(builder: GenerateImageRequestBuilder) -> Result<ImageGenerationDraftOrRequest, ArtcraftRouterError> {
  let request = build_artcraft_omni_image_request(builder, CommonImageModelEnum::Flux1Schnell)?;
  Ok(ImageGenerationDraftOrRequest::Request(ImageGenerationRequest::ArtcraftFlux1Schnell(ArtcraftFlux1SchnellRequestState { request })))
}
