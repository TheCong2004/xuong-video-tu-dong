...
mod tests {
  ...
  fn cost_for(n: FluxPro11UltraNumImages) -> ImageGenerationCostEstimate {
    let state = FalFluxPro1p1UltraCostState::from_request(&FalFluxPro1p1UltraRequestState { request: FluxPro11UltraRequest { prompt: "test".to_string(), aspect_ratio: FluxPro11UltraAspectRatio::Square, num_images: n } });
    state.estimate_cost()
  }
