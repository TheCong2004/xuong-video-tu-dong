...
mod tests {
  ...
  use fal_client::requests::api::image::text::flux_1_dev_text_to_image::api::{Flux1DevTextToImageAspectRatio, Flux1DevTextToImageNumImages};
  ...
  mod text_to_image {
    ...
    fn t2i_request() -> FalFlux1DevRequestState {
      FalFlux1DevRequestState::TextToImage(Flux1DevTextToImageRequest { prompt: "a corgi wearing sunglasses on a surfboard".to_string(), num_images: Flux1DevTextToImageNumImages::One, aspect_ratio: Flux1DevTextToImageAspectRatio::LandscapeSixteenByNine })
    }
  ...
  mod edit_image {
    ...
    fn edit_request() -> FalFlux1DevRequestState {
      FalFlux1DevRequestState::EditImage(Flux1DevEditImageRequest { prompt: "turn this into a watercolor painting".to_string(), image_url: JUNO_AT_LAKE_IMAGE_URL.to_string(), num_images: Flux1DevEditImageNumImages::One })
    }
