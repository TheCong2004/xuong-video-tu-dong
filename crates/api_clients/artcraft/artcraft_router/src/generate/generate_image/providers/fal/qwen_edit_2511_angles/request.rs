...
mod tests {
  ...
  use fal_client::requests::api::image::angle::qwen_edit_2511_edit_image_angle::api::{QwenEdit2511AngleImageSize, QwenEdit2511AngleNumImages};
  ...
  async fn send_via_webhook() {
    ...
    let state = FalQwenEdit2511AnglesRequestState { request: QwenEdit2511EditImageAngleRequest { image_urls: vec![JUNO_AT_LAKE_IMAGE_URL.to_string()], horizontal_angle: Some(45.0), vertical_angle: Some(-15.0), zoom: Some(2.0), additional_prompt: Some("cinematic".to_string()), num_images: Some(QwenEdit2511AngleNumImages::One), image_size: Some(QwenEdit2511AngleImageSize::SquareHd), lora_scale: None, guidance_scale: None, num_inference_steps: None } };
