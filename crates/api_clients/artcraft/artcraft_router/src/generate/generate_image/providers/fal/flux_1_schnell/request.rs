...
mod tests {
  ...
  use fal_client::requests::api::image::text::flux_1_schnell_text_to_image::api::{Flux1SchnellTextToImageAspectRatio, Flux1SchnellTextToImageNumImages};
  ...
  mod text_to_image {
    ...
    fn t2i_request() -> FalFlux1SchnellRequestState {
      FalFlux1SchnellRequestState::TextToImage(Flux1SchnellTextToImageRequest { prompt: "a corgi wearing sunglasses on a surfboard".to_string(), num_images: Flux1SchnellTextToImageNumImages::One, aspect_ratio: Flux1SchnellTextToImageAspectRatio::LandscapeSixteenByNine })
    }
  ...
  mod edit_image {
    ...
    fn edit_request() -> FalFlux1SchnellRequestState {
      FalFlux1SchnellRequestState::EditImage(Flux1SchnellEditImageRequest { image_url: JUNO_AT_LAKE_IMAGE_URL.to_string(), num_images: Flux1SchnellEditImageNumImages::One, image_size: None })
    }
