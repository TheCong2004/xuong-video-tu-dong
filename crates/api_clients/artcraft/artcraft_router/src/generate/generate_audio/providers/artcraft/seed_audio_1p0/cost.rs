...
mod tests {
  ...
  fn flat_cost_is_twenty_one_cents() {
    let builder = GenerateAudioRequestBuilder { model: RouterAudioModel::SeedAudio1p0, provider: RouterProvider::Artcraft, prompt: Some("a suspense radio drama".to_string()), ..Default::default() };
