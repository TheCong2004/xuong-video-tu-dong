...
mod tests {
  ...
  fn flat_cost_is_eight_cents() {
    let builder = GenerateAudioRequestBuilder { model: RouterAudioModel::SunoMusic, provider: RouterProvider::Artcraft, prompt: Some("a song".to_string()), ..Default::default() };
