...
pub enum DownloadError {
  BadStatus { url: String, status_code: u16 },

  ReqwestDownload { url: String, error: reqwest::Error, maybe_status: Option<reqwest::StatusCode> },

  WreqDownload { url: String, error: wreq::Error, maybe_status: Option<wreq::StatusCode> },
}
