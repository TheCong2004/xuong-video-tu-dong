...
use crate::core::commands::pipeline::capcut_draft_commands::{open_floword_capcut_draft_command, rebuild_floword_capcut_draft_command};
...
pub fn run() {
  ...
  let builder = builder.invoke_handler(tauri::generate_handler![
    ...
    rebuild_floword_capcut_draft_command,
    open_floword_capcut_draft_command,
