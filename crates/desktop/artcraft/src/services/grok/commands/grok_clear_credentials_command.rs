...
#[tauri::command]
pub async fn grok_clear_credentials_command(root: State<'_, AppDataRoot>, creds_manager: State<'_, GrokCredentialManager>) -> SimpleResponse {
...
fn clear_creds(root: &AppDataRoot, creds: &GrokCredentialManager) -> AnyhowResult<()> {
