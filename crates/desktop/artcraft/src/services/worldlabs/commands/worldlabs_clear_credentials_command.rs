...
#[tauri::command]
pub async fn worldlabs_clear_credentials_command(root: State<'_, AppDataRoot>, creds_manager: State<'_, WorldlabsCredentialManager>) -> SimpleResponse {
...
fn clear_creds(root: &AppDataRoot, creds: &WorldlabsCredentialManager) -> AnyhowResult<()> {
